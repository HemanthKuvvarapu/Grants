...
<br /><p style="color:red">
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="border: solid 1px black;
        ...
        <tr>
            <td style="padding: 5px;width:80%">
                    <b>Please Note: The Required Grant Forms will need to be submitted as hard copies and submitted electronically, as these do not print as part of the PDF document. Please download the forms and attach them to the hard Copy of the Grant Application. </b>
            </td>
            </tr>
