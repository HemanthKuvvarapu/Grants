...
public partial class controls_NavMenuItemNew : System.Web.UI.UserControl
{
    ...
    protected void lnkMenuItem_Click(object sender, EventArgs e)
    {
        ...
        if (sArg == "Home")
        {
            //if (Session["CPPIHome"] != null && Session["CPPIHome"].ToString() == "1")
            //{
            //    Response.Redirect("~/CPPI/2019/CPPIHome.aspx");
            //}
            ...
            else if (Session["CPPIHome"] != null && Session["CPPIHome"].ToString() == "1")
            {
                Response.Redirect("~/CPPI/" + AppInfo.FiscalYear + "/CPPIHome.aspx");
            }
            else
            {
