...
WHERE GrantApplicantId = " + grantApplicantId.ToString() + " ORDER BY p.RegionId";
    ...
    public int SavePDFCheckList(int GrantApplicantId,
           ...
           int E18, int E22, int E23, int E24, int E25, int E26, int E27,
           int F18, int F19)
    {
...
WHERE g.GrantApplicantId = " + grantApplicantId.ToString()));
    ...
    public int SaveBudgetNarrativeData(string budgetNarrativeID,
                                                ...
                                                int IsPCHP)
    {
        SqlParameter[] pArray = new SqlParameter[276];
        pArray[0] = new SqlParameter("@BudgetNarrativeID", SqlDbType.Int);
        pArray[0].Direction = ParameterDirection.InputOutput;
        ...
        pArray[269] = new SqlParameter("@IsPCHP", SqlDbType.Int);
        pArray[269].Value = IsPCHP;
    ...
    public DataSet GetBudgetPCHPNarrativeDataNew(int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[3];
        ...
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetBudgetPCHPNarrativeDataNew", pArray);
    ...
    public DataSet GetBudgetPCHPNarrativeData(int GrantApplicantId, int isLeadAgency)
    {
        SqlParameter[] pArray = new SqlParameter[2];
        pArray[0] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[0].Value = GrantApplicantId;
        ...
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetBudgetPCHPNarrativeData", pArray);
    }

    public int SaveBudgetPCHPNarrativeData(string budgetNarrativeID,
                                                int GrantApplicantId,
                                                string agencyName,
                                                string agencyEmail,
                                                string agencyPhone,
                                                ...
                                                int NumberOfChildren)
    {
        ...
        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspSaveBudgetPCHPNarrativeData", pArray);
