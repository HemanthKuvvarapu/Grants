...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-family: Arial;
        ...
        <tr>
            <td>
                <b>Part 12 - ADMINISTRATIVE FORMS: </b> A new SIGNED ISA and Department's Contractor Authorized Signatory Listing with original ink signatures must be submitted for each new contract with the Commonwealth.
            </td>
        </tr>
    </table>
    <br />
...
<br /><p style="color:red">
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="border: solid 1px black;
        ...
        <tr>
            <td style="padding: 5px;width:80%">
                    <b>Please Note: The Required Grant Forms will need to be submitted as hard copies and submitted electronically, as these <u>do not</u> print as part of the PDF document. Please download the forms and attach them to the hard Copy of the Grant Application.</b>
            </td>
            </tr>
