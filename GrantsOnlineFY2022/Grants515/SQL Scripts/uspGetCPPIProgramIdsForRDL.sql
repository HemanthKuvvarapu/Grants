...
/****** Object:  StoredProcedure [dbo].[uspGetCPPIProgramIDsForRDL]    Script Date: 11/7/2018 1:15:26 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[uspGetCPPIProgramIDsForRDL] @GrantApplicantID INT
AS

	CREATE TABLE #tmpCPPIProgramIds (
	...
	FROM #tmpCPPIProgramIds

	DROP TABLE #tmpCPPIProgramIds
