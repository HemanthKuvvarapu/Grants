                ...
                <table id="tblSuccess" cellpadding="0" cellspacing="0" border="0" class="styleSaved"
                    ...
                    <tr>
                        <td align="center" style="height: 50px; padding-top: 5px">
                            The Subcontractor Budget has been SAVED successfully.<br />
                            <br />
                            <asp:LinkButton ID="lnkBackToHome" runat="server" Text="Go back to Subcontractor list" Visible="true"
        ...
        <tr>
            <td colspan="7">
                <table id="tblFailed" cellpadding="0" cellspacing="0" border="0" class="styleFailed"
                    ...
                    <tr>
                        <td align="center" style="height: 50px; padding-top: 5px">
                            <span class="styleErrors">The Subcontractor Budget has been SAVED with the following error(s).<br />
        ...
        <tr>
            <td colspan="7">
                <table id="tblWarnings" cellpadding="0" cellspacing="0" border="0" class="styleWarning"
                    ...
                    <tr>
                        <td align="center" style="height: 50px; padding-top: 5px">
                            <span class="styleErrors">The Subcontractor Budget has been SAVED with the following warning(s).<br />
                ...
                <table cellpadding="0" cellspacing="0" class="style41" style="width: 100%;border:1px solid #999999;background-color:#efefef">
                    <tr>
                        <td style="width: 240px">
                            <b>Name of Subcontractor<span style="color: Red">*</span>:</b>
                        </td>
                        <td valign="middle">
                            <asp:TextBox ID="txtSubcontractorName" runat="server" Width="400px" MaxLength="100" style="margin-top:5px;margin-bottom:5px"></asp:TextBox><br />
                            <asp:RequiredFieldValidator
                                ID="rfvSCName" runat="server" ControlToValidate="txtSubcontractorName" ErrorMessage="Please enter the subcontractor name."
                                Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 240px">
                            <b>Contact name<span style="color: Red">*</span>:</b>
                        </td>
                        <td valign="middle">
                            ...
                            <asp:RequiredFieldValidator
                                ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSubcontractorContact" ErrorMessage="Please enter the subcontractor contact name."
                                Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td valign="middle">
                            ...
                            <asp:RequiredFieldValidator
                                ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSubcontractorEmail" ErrorMessage="Please enter the subcontractor email."
                                Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        ...
                        <td valign="middle">
                            ...
                            617-111-2222)<br />
                            <asp:RequiredFieldValidator
                                ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSubcontractorPhone" ErrorMessage="Please enter the subcontractor phone."
                                Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: 80px">
        <tr>
            <td align="center">
                ...
                <asp:LinkButton ID="btnSaveHome" CssClass="buttonClass" runat="server" Text="Save Subcontractor Budget"
