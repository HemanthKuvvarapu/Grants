    ...
    <table id="tblSuccess" cellpadding="0" cellspacing="0" border="0" class="styleSaved"
        ...
        <tr>
            <td align="center" style="height:50px;padding-top:5px">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:LinkButton ID="lnkNextPart" runat="server" Text="Go to Communities Served (Part 2)" Visible="true"
                    OnClick="btnNextPart_Click" CausesValidation="false" CssClass="buttonClass2" Width="250px" />
                <br /><br />
            </td>
        </tr>
    </table>
    <table id="tblData" runat="server" cellpadding="0" style="width: 100%;" cellspacing="0"
        ...
        <tr>
            <td colspan="2" height="25px" class="styleSubTitle">
                <b>Lead Agency Grant Coordinator Information</b>
            </td>
        </tr>
        <tr>
            <td colspan="2">
