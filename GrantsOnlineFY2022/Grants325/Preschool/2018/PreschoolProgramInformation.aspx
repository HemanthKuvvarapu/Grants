<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage4.master" AutoEventWireup="true" CodeFile="PreschoolProgramInformation.aspx.cs" Inherits="Preschool_2018_PreschoolProgramInformation" %>
                    ...
                    <tr>
                        ...
                        To create a record for a IPLE site, click the "<b>Add New Program</b>" button below.
                            ...
                            <ol type="a">
                                ...
                                <li>Please review and revise responses, as needed, to ensure information provided in the Site Survey is consistent will all other sections of the Grant Application prior to submitting the FY <%=AppInfo.FiscalYear %> grant application.</li>
                                <li><span style="red">Please note that if all information for the site is deleted or if any information in the site survey is not completed in full, the site will not be eligible FY <%=AppInfo.FiscalYear %> IPLE funding.</span></li>
                            </ol> 
                        <br /><br />
                        </td>
                    </tr>
        ...
        <tr>
            <td>
                <table cellpadding="5" id="tblCenter" runat="server" style="width: 100%;">
                    <tr>
                        <td style="background-color:#ffffff"><b>Instructions</b>: The following questions pertain to the IPLE- funded settings and the IPLE-preschool sessions that the Lead Agency is proposing as the designated settings for FY <%=AppInfo.FiscalYear %> Inclusive Preschool Learning Environments Grant. 
                        <br /><br />
                        ...
                        <b>For the FY <%=AppInfo.FiscalYear %> Grant Application, applicants must provide responses to Questions 1 thru 19 including all questions about anticipated enrollments for October 1, <%=AppInfo.FiscalYear - 1%></b><br /><br />
All questions in the IPLE site survey must be completed in full.<br /><br /><b>Please remember to save your information frequently</b>.</td>
                    </tr>
                    <tr style="background-color: #6699FF; color: #FFFFFF">
            <td style="font-size: larger;height:25px">&nbsp;&nbsp;<b>Program Information</b></td>
                    ...
                    <tr>
                        <td><span style="color: red; font-weight: bold;">*</span>&nbsp;<b>1. What is this program's EEC Program Number<sup>2</sup>? If you do not know your program's EEC Program Number or QRIS Program Number, please contact the EEC Program Quality Technical Desk via the following link: eecqris@mass.gov
                        <a href="mailto:eecqris@mass.gov">eecqris@mass.gov</a></b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="padding-left: 50px;">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="width:180px">*2a. As of June 1, <%=AppInfo.FiscalYear - 1%></td>
                                    <td>
                    ...
                    <tr>
                        <td style="padding-left: 50px;">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="width:180px">2b. As of December 1, <%=AppInfo.FiscalYear - 1%></td>
                                    <td>
                    ...
                    <tr>
                        <td style="padding-left: 50px;">
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="width:180px">2c. As of June 1, <%=AppInfo.FiscalYear %></td>
                                    <td>
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td style="width:85%"><span style="color: red; font-weight: bold;">*</span><b>8. How many IPLE-funded preschool sessions<sup>4</sup> will be available at this site in FY <%=AppInfo.FiscalYear %>?
                                        </b></td>
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="width:85%"><span style="color: red; font-weight: bold;">*</span><b>9. How many weeks between July 1, <%=AppInfo.FiscalYear - 1%> and June 30, <%=AppInfo.FiscalYear %> will this IPLE-funded site provide grant-funded services? <span style="color:red">(Maximum Number must not exceed 52 weeks)</span>.</b></td>
                    ...
                    <tr>
                        <td><b>13. How many children were enrolled in IPLE-funded session(s) according to the IPLE operating schedules at this site on December 1, <%=AppInfo.FiscalYear - 1%>?</b><br /></td>
                    ...
                    <tr>
                        ...
                        <br />
                            <table cellpadding="5" cellspacing="0" border="0" style="border:solid 1px #333333" rules="all">
                                ...
                                <tr>
                                    <td style="width:40%"><b><span style="color:red">DECEMBER <%=AppInfo.FiscalYear - 1%> REPORTING: ACTUAL ENROLLMENT</span></b></td>
                                    <td style="text-align:center"><b>Total number of<br /> children</b></td>
                                    <td style="text-align:center"><b>2 days/week</b></td>
                                    <td style="text-align:center"><b>3 days/week</b></td>
                                    <td style="text-align:center"><b>4 days/week</b></td>
                    ...
                    <tr>
                        <td><b>14. How many children were enrolled in IPLE-funded session(s) according to the IPLE operating schedules at this site on June 1, <%=AppInfo.FiscalYear %>?</b><br /></td>
                    ...
                    <tr>
                        ...
                        <br />
                            <table cellpadding="5" cellspacing="0" border="0" style="border:solid 1px #333333" rules="all">
                                ...
                                <tr>
                                    <td style="width:40%"><b><span style="color:red">JUNE <%=AppInfo.FiscalYear %> REPORTING: ACTUAL ENROLLMENT</span></b></td>
                                    <td style="text-align:center"><b>Total number of<br /> children</b></td>
                                    <td style="text-align:center"><b>2 days/week</b></td>
                                    <td style="text-align:center"><b>3 days/week</b></td>
                                    <td style="text-align:center"><b>4 days/week</b></td>
                    ...
                    <tr>
                        ...
                        * An enrollment number for "Anticipated Enrollment by October 1, <%=AppInfo.FiscalYear - 1%>" must be submitted with the FY <%=AppInfo.FiscalYear %> Grant Application. 
                        <br /><br />
                        Note: for actual enrollment numbers, if the enrollment numbers are not yet available, please fill in the boxes with a "0".<br />
                        ** Awarded IPLE Grantees will be required to update these responses to satisfy the FY <%=AppInfo.FiscalYear %> IPLE Performance Reporting Requirements.
                        <br /><br />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <br />
                            <table cellpadding="5" cellspacing="0" border="0" style="border:solid 1px #333333" rules="all">
                                <tr>
                                    <td style="width:40%"><b>IPLE Enrollment by Age<sup>5</sup> of Child and Disability Status</b></td>
                                    <td style="width:20%;text-align:center" colspan="2"><b style="color:red">Anticipated 
                                        Enrollment October 1, <%=AppInfo.FiscalYear - 1%> 
                                        <span style="color:red">*</span></b></td>
                                    <td style="width:20%;text-align:center" colspan="2"><b>Actual Enrollment December 1, <%=AppInfo.FiscalYear - 1%> 
                                        **</b></td>
                                    <td style="width:20%;text-align:center" colspan="2"><b>Actual Enrollment<br />
                                        June 1 , <%=AppInfo.FiscalYear %> 
                                        **</b></td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td><span style="color: red; font-weight: bold;">*</span>&nbsp;<b>16. Demographic<sup>6</sup> Information for Children who are 3 years old and enrolled in IPLE Sessions</b></td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px;">
                        <br />
                            <table cellpadding="5" cellspacing="0" border="0" style="border:solid 1px #333333"  rules="all">
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:center"><b style="color:red">Anticipated Enrollment
                                        <br />
                                        October 1, <%=AppInfo.FiscalYear - 1%>**</b></td>
                                    <td style="width:20%;text-align:center"><b>Actual Enrollment December 1, <%=AppInfo.FiscalYear - 1%></b></td>
                                    <td style="width:20%;text-align:center"><b>Actual Enrollment 
                                        <br />
                                        June 1, <%=AppInfo.FiscalYear %></b></td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td><span style="color: red; font-weight: bold;">*</span>&nbsp;<b>17. Demographic<sup>6</sup> Information for Children who are 4 years old and enrolled in IPLE Sessions</b></td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px;">
                        <br />
                    ...
                    <tr>
                        <td><span style="color: red; font-weight: bold;">*</span>&nbsp;<b>18. Demographic<sup>6</sup> Information for Children who are 5 years old and enrolled in IPLE Sessions</b></td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px;">
                        <br />
                            <table cellpadding="5" cellspacing="0" border="0" style="border:solid 1px #333333" rules="all">
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:center"><b style="color:red">Anticipated Enrollment by
                                        <br />
                                        October 1, <%=AppInfo.FiscalYear - 1%> 
                                        <span style="color:red">**</span></b></td>
                                    <td style="width:20%;text-align:center"><b>Actual Enrollment December 1, <%=AppInfo.FiscalYear - 1%></b></td>
                                    <td style="width:20%;text-align:center"><b>Actual Enrollment 
                                        <br />
                    ...
                    <tr>
                        <td><span style="color: red; font-weight: bold;">*</span>&nbsp;<b>19. Demographic<sup>6</sup> Information for Children who are <u>under 3 years old</u> and enrolled in IPLE Sessions</b></td>
                    </tr>
                    <tr>
                        <td style="padding-left: 50px;">
                        <br />
                            <table cellpadding="5" cellspacing="0" border="0" style="border:solid 1px #333333" rules="all">
                                <tr>
                                    ...
                                    <td style="width:20%;text-align:center"><b style="color:red">Anticipated Enrollment<br />October 1, <%=AppInfo.FiscalYear - 1%> 
                                        <span style="color:red">**</span></b></td>
                                    <td style="width:20%;text-align:center"><b>Actual Enrollment<br />December 1, <%=AppInfo.FiscalYear - 1%></b></td>
                                    <td style="width:20%;text-align:center"><b>Actual Enrollment<br />June 1, <%=AppInfo.FiscalYear %></b></td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        ...
                        <br />
                            <table cellpadding="5" cellspacing="0" border="0" style="border:solid 1px #333333" rules="all">
                                ...
                                <tr>
                                    <td style="width:40%">&nbsp;</td>
                                    <td style="text-align:center"><b>Actual Enrollment<br />December 1, <%=AppInfo.FiscalYear - 1%></b></td>
                                    <td style="text-align:center"><b>Actual Enrollment<br />June 1, <%=AppInfo.FiscalYear %></b></td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td><b>23. High Needs Children<br /><br />
                            Number of who have been identified as "High Needs"<sup>7</sup></b></td>
...
If you do not know your program's EEC Program Number or QRIS Program Number, please contact the EEC Program Quality Technical Desk via the following link: <a href="eecqris@mass.gov">eecqris@mass.gov</a>
                  <br /><br />
            </td>
        </tr>
        <tr>
            <td style="font-size:smaller;font-family:arial">
                  <sup>3</sup> <b>All FY <%=AppInfo.FiscalYear - 1%> IPLE-funded sites must have at least one designated QRIS Program Administrator</b>. Please note a current EEC Single Sign In User Name and password, and current profile in the EEC Professional Qualifications Registry (PQR) are required to access EEC's online QRIS application system, the QRIS Program Manager (QPM). 
                  <br /><br />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="font-size:smaller;font-family:arial">
                  <sup>5</sup> <b>3-year-old/4-year-old/5-year-old:</b> Children considered to be 3 years old during the <%=AppInfo.FiscalYear - 1%>-<%=AppInfo.FiscalYear %> school year are those eligible for entry into kindergarten two years later, during the 2018-2019 school year. Children considered to be 4 years old during the <%=AppInfo.FiscalYear - 1%>-<%=AppInfo.FiscalYear %> school year are those eligible for entry into kindergarten one year later, during the 2018-2019 school year. Children considered to be 5 years old during the <%=AppInfo.FiscalYear - 1%>-<%=AppInfo.FiscalYear %> school year are 5-year-olds who were already eligible for kindergarten at the beginning of the <%=AppInfo.FiscalYear - 1%>-<%=AppInfo.FiscalYear %> program year.  
                  <br /><br />
            </td>
        </tr>
        <tr>
