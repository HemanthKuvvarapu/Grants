...
public partial class PDFCheckList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            disableNotApplicableCheckboxes();
            BindData(false);
        }
    }

    private void disableNotApplicableCheckboxes()
    {
        if (!AppInfo.DisplayPart2) chkA3.Visible = chkE3.Visible = false;
        if (!AppInfo.DisplayPart7) chkA7.Visible = chkE7.Visible = false;
        if (!AppInfo.DisplayPart8) chkA18.Visible = chkE18.Visible = false;
    }
