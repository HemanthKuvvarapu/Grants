...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <table id="tblHSBudget" style="width: 100%; font-family: Arial; font-size: 13px">
                    ...
                    <table id="tblSuccess" cellpadding="0" cellspacing="0" border="0" class="styleSaved"
                        ...
                        <tr>
                            <td align="center" style="height: 50px; padding-top: 5px">
                                ...
                                <asp:LinkButton ID="lnkNextPart" runat="server" Text="Go to Subcontractor Budget (Part 5)"
            ...
            <tr>
                <td class="style41">
                    Stipend-<br />Administrators only
                </td>
                <td class="style315">
                    &nbsp;
                </td>
            ...
            <tr>
                <td class="style41">
                    Stipend <br />Instructional/Professional Staff only
