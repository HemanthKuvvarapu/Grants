<%@ Page Title="Cover Page" Language="C#" MasterPageFile="~/MasterPageNEW.master" AutoEventWireup="true" CodeFile="CoverPage.aspx.cs" Inherits="CoverPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="tblCoverPage" runat="server" cellpadding="0" cellspacing="0" width="100%" border="0" style="padding-top:5px;padding-bottom:5px;border:solid 1px #333333">
            ...
            <tr>
                <td>&nbsp;</td>
                <td><asp:Literal ID="lblDocId" runat="server"></asp:Literal></td>
            </tr>
     </table>
