...
public partial class AdminViewContent : System.Web.UI.Page
{
    ...
    protected void lbtnShowPart4aData_Click(object sender, EventArgs e)
    {
        BindData("part4a");
    }
   ...
   protected void lbtnShowLEASUBrprt_Click(object sender, EventArgs e)
   {
    ...
    protected void lbtnShowPCHPFamilyFrom_Click(object sender, EventArgs e)
    {
        BindData("pchpfamilyform");
    }
}
