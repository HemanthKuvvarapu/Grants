<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BudgetAmendmentSubcontractor.aspx.cs" Inherits="BudgetAmendmentSubcontractor" Title="Untitled Page" %>
        ...
        <tr>
            <td colspan="7">
                <table cellpadding="0" cellspacing="0" class="style41" style="width: 100%;border:1px solid #999999;background-color:#efefef">
                    <tr>
                        <td>
                            <b>Name of Subcontractor:</b>&nbsp;<asp:Label ID="txtSubcontractorName" runat="server" Width="400px" style="margin-top:5px;margin-bottom:5px"></asp:Label>
                        </td>
                        <td valign="middle">
                           <br />
                        </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: 80px">
        <tr>
            <td align="center">
                ...
                <asp:LinkButton ID="btnSaveHome" CssClass="buttonClass" runat="server" Text="Save Subcontractor Budget Amendment"
