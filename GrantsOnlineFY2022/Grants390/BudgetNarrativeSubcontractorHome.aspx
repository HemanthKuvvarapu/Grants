<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="BudgetNarrativeSubcontractorHome.aspx.cs" Inherits="BudgetNarrativeSubcontractorHome" Title="Untitled Page" %>
        ...
        <table id="tblSCs" runat="server" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <asp:GridView ID="grdSCs" runat="server" AutoGenerateColumns="False" DataKeyNames="BudgetNarrativeID"
                        ...
                        <EmptyDataTemplate>
                            <table cellpadding="0" cellspacing="0" border="0" style="width:100%;color:#ff0000">
                                <tr>
                                    <td align="center"><b>No Subcontractor Found</b></td>
                                </tr>
                            </table>
                        </EmptyDataTemplate>
            ...
            <tr>
                <td align="center" style="height:70px">
                    <asp:Button ID="btnAddNew" runat="server" Text="Add New Subcontractor" 
