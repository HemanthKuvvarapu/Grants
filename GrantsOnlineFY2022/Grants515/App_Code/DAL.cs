...
WHERE GrantApplicantId = " + grantApplicantId.ToString() + " ORDER BY p.RegionId";
    ...
    public int SavePDFCheckList(int GrantApplicantId,
           ...
           int E18, 
           int E22, int E23, int E24, int E25, int E26,
           int F18, int F19
           )
    {
    ...
    public int DeleteSubcontractorData(int SCID, int fundCode, int fiscalYear)
    {
        SqlParameter[] pArray = new SqlParameter[3];
    ...
    public int DeleteUpkClassroomNew(int ClassroomId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        pArray[0] = new SqlParameter("@ClassroomId", SqlDbType.Int);
        pArray[0].Value = ClassroomId;


        return Convert.ToInt32(SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspDeleteUpkClassroomNew", pArray));
    }
    ...
    public DataSet GetUpkClassroomsNew(int SystemProvidersId, int GrantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[2];

        pArray[0] = new SqlParameter("@SystemProviderId", SqlDbType.Int);
        pArray[0].Value = SystemProvidersId;

        pArray[1] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[1].Value = GrantApplicantId;

        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetAllUpkProgramClassroomNew", pArray);
    }

    public DataSet GetUpkClassroom(int ClassroomId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
    ...
    public SortedList<string, string> GetUpkClassroomNew(int ClassroomId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        ...
        DataSet ds = SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetUPKClassroomSurveyData", pArray);
        ...
        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        {
            ...
            if (!questions.ContainsKey(dr["QuestionId"].ToString()))
            {
...
WHERE g.GrantApplicantId = " + grantApplicantId.ToString()));
    ...
    public DataSet GetUpkSystemProvidersNew(int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        pArray[0] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[0].Value = grantApplicantId;

        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetAllUpkProgramsNew", pArray);
    }

    public string CheckCPPIFinalSubmit(int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        pArray[0] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[0].Value = grantApplicantId;

        DataSet ds = SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspCheckCPPIFinalSubmit", pArray);

        return ds.Tables[0].Rows[0]["ErrMsg"].ToString();
    }

    public DataSet GetCPPISystemProviders(int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        pArray[0] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[0].Value = grantApplicantId;

        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetAllCPPIPrograms", pArray);
    }
    
    public int GetCPPISystemProviderId(int grantApplicantId, string AgencyName)
    {
        SqlParameter[] pArray = new SqlParameter[2];
        pArray[0] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[0].Value = grantApplicantId;

        pArray[1] = new SqlParameter("@AgencyName", SqlDbType.VarChar);
        pArray[1].Value = AgencyName;

        return Convert.ToInt32(SqlHelper.ExecuteScalar(GetConnectionString(), CommandType.StoredProcedure, "uspGetCPPISystemProviderId", pArray));
    }

    public DataSet GetCPPISystemProvidersNew(int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        ...
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetAllCPPIProgramsNew", pArray);
    }

    public DataSet GetCPPISystemProvidersNew(int grantApplicantId, int fiscalYear)
    {
        SqlParameter[] pArray = new SqlParameter[2];
    ...
    public int GetCPPIClassroomNewId(int SystemProviderId, int GrantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[3];
        ...
        pArray[2] = new SqlParameter("@ClassroomId", SqlDbType.Int);
        pArray[2].Direction = ParameterDirection.InputOutput;
        pArray[2].Value = -1;

        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspGetCPPISurveyClassroomNewId", pArray);

        return Int32.Parse(pArray[2].Value.ToString());
    }

    public void DeleteCPPISurveyClassroomEducator(int EducatorId)
    {

        SqlParameter[] pArray = new SqlParameter[5];

        pArray[0] = new SqlParameter("@EducatorId", SqlDbType.Int);
        pArray[0].Value = EducatorId;

        SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspDeleteCPPISurveyClassroomEducator", pArray);
    }

    public int DeleteCPPIProgramNew(int providerId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        pArray[0] = new SqlParameter("@ProviderId", SqlDbType.Int);
        pArray[0].Value = providerId;
        ...
        return Convert.ToInt32(SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspDeleteCPPIProgramNew", pArray));
    }

    public int DeleteCPPIClassroomNew(int ClassroomId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        pArray[0] = new SqlParameter("@ClassroomId", SqlDbType.Int);
        pArray[0].Value = ClassroomId;
        ...
        return Convert.ToInt32(SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspDeleteCPPIClassroomNew", pArray));
    }

    public DataSet GetCPPIClassroomsNew(int SystemProvidersId, int GrantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[2];
        ...
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetAllCPPIProgramClassroomNew", pArray);
    }

    public SortedList<string, string> GetCPPIClassroomNew(int ClassroomId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        ...
        DataSet ds = SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetCPPIClassroomSurveyData", pArray);
    ...
    public DataSet GetCPPIProgramInformation(int SystemProviderId, string QuestionId)
    {
        SqlParameter [] pArray = new SqlParameter[2];
        ...
        DataSet ds = SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetCPPIProgramInformation", pArray);

        return ds;
    }

    public SortedList<string, string> GetCPPIProgramSurveyData(int SystemProviderId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        ...
        DataSet ds = SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetCPPIProgramSurveyData", pArray);
    ...
    public DataSet GetCPPIPartStatus(int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        ...
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetCPPIPartStatus", pArray);
    }

    public float UpdateCPPIClassroomAmountNew(int classroomId, int systemProviderId, int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[4];
        ...
        pArray[1] = new SqlParameter("@ClassroomId", SqlDbType.Int);
        pArray[1].Value = classroomId;

        pArray[2] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[2].Value = grantApplicantId;

        pArray[3] = new SqlParameter("@Amount", SqlDbType.Float);
        pArray[3].Direction = ParameterDirection.Output;

        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspUpdateCPPIClassroomAmountNew", pArray);

        return Single.Parse(pArray[3].Value.ToString());
    }

    public float UpdateCPPIEligAmountNew(int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[3];
        ...
        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspUpdateCPPIEligibilityAmountNew", pArray);

        return (string.IsNullOrEmpty(pArray[1].Value.ToString()) ? 0f : Single.Parse(pArray[1].Value.ToString()));
    }

    public int SaveCPPIClassroomSurveyData(int ClassroomId, int SystemProviderId, string QuestionId, string QuestionAns, int GrantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[6];
        ...
        pArray[4] = new SqlParameter("@SystemProviderId", SqlDbType.Int);
        pArray[4].Value = SystemProviderId;

        pArray[5] = new SqlParameter("@RETURNVALUE", System.Data.SqlDbType.Int);
        pArray[5].Direction = System.Data.ParameterDirection.ReturnValue;

        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspSaveCPPIClassroomSurveyData", pArray);

        //return Int32.Parse(pArray[0].Value.ToString());
        return Int32.Parse(pArray[5].Value.ToString());
    }

    public void SaveCPPIPartStatus(int grantApplicantId, string part, int status)
    {
        SqlParameter[] pArray = new SqlParameter[3];
        ...
        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspSaveCPPIPartStatus", pArray);
    }

    public DataSet GetCPPIClassroomCounts(int SystemProviderID, int GrantApplicantID, int Column)
    {
        SqlParameter[] pArray = new SqlParameter[3];
        ...
        pArray[2] = new SqlParameter("@Column", SqlDbType.Int); 
        pArray[2].Value = Column;

        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetCPPIClassroomCounts", pArray);
    }

    public DataSet GetCPPIDistrictInformation(int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        pArray[0] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[0].Value = grantApplicantId;

        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetCPPIDistrictInformation", pArray);
    }

    public int SaveCPPIDistrictInformation(int grantApplicantId, string DistrictName, int TotalEnrollment, decimal HighSchoolGradRate, decimal PctMeetExceed3rdGrade, decimal PctMeetExceedELA, decimal PctMeetExceedMath, decimal PctRetentionEarlyK2, decimal PctSuspensionK5)
    {
        ...
        pArray[1] = new SqlParameter("@DistrictName", SqlDbType.VarChar);
        pArray[1].Value = DistrictName;

        pArray[2] = new SqlParameter("@TotalEnrollment", SqlDbType.Int);
        pArray[2].Value = TotalEnrollment;

        pArray[3] = new SqlParameter("@HighSchoolGradRate", SqlDbType.Decimal);
        pArray[3].Value = HighSchoolGradRate;

        pArray[4] = new SqlParameter("@PctMeetExceed3rdGrade", SqlDbType.Decimal);
        pArray[4].Value = PctMeetExceed3rdGrade;

        pArray[5] = new SqlParameter("@PctMeetExceedELA", SqlDbType.Decimal);
        pArray[5].Value = PctMeetExceedELA;

        pArray[6] = new SqlParameter("@PctMeetExceedMath", SqlDbType.Decimal);
        pArray[6].Value = PctMeetExceedMath;

        pArray[7] = new SqlParameter("@PctRetentionEarlyK2", SqlDbType.Decimal);
        pArray[7].Value = PctRetentionEarlyK2;

        pArray[8] = new SqlParameter("@PctSuspensionK5", SqlDbType.Decimal);
        pArray[8].Value = PctSuspensionK5;

        return SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspSaveCPPIDistrictInformation", pArray);

    }

    public int SaveCPPIProgramSurveyData(int SystemProviderId, string QuestionId, string QuestionAns, int GrantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[4];
        ...
        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspSaveCPPIProgramSurveyData", pArray);

        return Int32.Parse(pArray[0].Value.ToString());
    }

    public int SaveCPPIProgramSurveyData(int SystemProviderId, string QuestionId, string QuestionAns, int GrantApplicantId, int UpdatePeriod)
    {
        SqlParameter[] pArray = new SqlParameter[5];
        ...
        pArray[4] = new SqlParameter("@UpdatePeriod", SqlDbType.Int);
        pArray[4].Value = UpdatePeriod;
    ...
    public DataSet GetCPPISurveyClassroomEducators(int classroomId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        ...
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetCPPISurveyClassroomEducators", pArray);
    }

    public void SaveCPPISurveyClassroomEducator(int ClassroomId, string EducatorName, string Position, string PQRNumber, string EducationLevel, string MajorProgramStudy, string Salary, int SystemProviderId, int GrantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[9];
        ...
        pArray[1] = new SqlParameter("@EducatorName", SqlDbType.VarChar, 300);
        pArray[1].Value = EducatorName;

        pArray[2] = new SqlParameter("@Position", SqlDbType.VarChar, 300);
        pArray[2].Value = Position;

        pArray[3] = new SqlParameter("@EducationLevel", SqlDbType.VarChar, 300);
        pArray[3].Value = EducationLevel;

        pArray[4] = new SqlParameter("@MajorProgramStudy", SqlDbType.VarChar, 100);
        pArray[4].Value = MajorProgramStudy;

        pArray[5] = new SqlParameter("@AnnualSalary", SqlDbType.VarChar, 50);
        pArray[5].Value = Salary;

        pArray[6] = new SqlParameter("@SystemProviderId", SqlDbType.Int);
        pArray[6].Value = SystemProviderId;

        pArray[7] = new SqlParameter("@GrantApplicantID", SqlDbType.Int);
        pArray[7].Value = GrantApplicantId;

        pArray[8] = new SqlParameter("@PQRNumber", SqlDbType.VarChar, 20);
        pArray[8].Value = PQRNumber;

        SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspSaveCPPISurveyClassroomEducator", pArray);
    }

    public void UpdateCPPISurveyClassroomEducator(int EducatorId, string EducatorName, string Position, string PQRNumber, string EducationLevel, string MajorProgramStudy, string Salary)
    {

        SqlParameter[] pArray = new SqlParameter[7];
        ...
        pArray[6] = new SqlParameter("@PQRNumber", SqlDbType.VarChar, 50);
        pArray[6].Value = PQRNumber;

        SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspUpdateCPPISurveyClassroomEducator", pArray);
    }

    public int SaveCPPIProgramInformation(int GrantApplicantId
        , int? ProgramTypeId
        , bool? IsHeadStartProgram
        , bool? IsProgramLicensed
        , int? WeeksPerYearOperation
        ...
        )
    {
        ...
        return Convert.ToInt32(SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspSaveCPPIProgramInformation", pArray));
    }
    ...
    public DataSet GetSubcontractorContactData(int SystemProviderId, int GrantApplicantId, int ContactID, int IsFiscalContact)
    {
        SqlParameter[] pArray = new SqlParameter[4];
        pArray[0] = new SqlParameter("@SystemProviderId", SqlDbType.Int);
        pArray[0].Value = SystemProviderId;
        ...
        pArray[2] = new SqlParameter("@ContactID", SqlDbType.Int);
        pArray[2].Value = ContactID;

        pArray[3] = new SqlParameter("@IsFiscalContact", SqlDbType.Int);
        pArray[3].Value = IsFiscalContact;

        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetSubcontractorContactData", pArray);
    }

    public DataSet GetContactAndBudgetNarrativeSubcontractorData(int SCID, int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[3];
        pArray[0] = new SqlParameter("@SCID", SqlDbType.Int);
        pArray[0].Value = SCID;
        ...
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetContactAndBudgetNarrativeSubcontractorData", pArray);

    }

    public int SaveSubcontractorContactData(int ContactID, 
                                                int GrantApplicantID, 
                                                int SystemProviderID,
                                                int BudgetNarrativeID,
                                                string SubContractorName,        
                                                string SubContractorContactName,
                                                string SubContractorAddress1,
                                                string SubContractorAddress2,
                                                string SubContractorCity,
                                                string SubContractorState,
                                                string SubContractorZipcode,
                                                string SubContractorPhone,
                                                string SubContractorFax,
                                                string SubContractorEmail,
                                                int IsFiscalContact)

    {
        //Add new stored proc to add Subcontractor Contact Data
        SqlParameter[] pArray = new SqlParameter[16];
        pArray[0] = new SqlParameter("@ContactID", SqlDbType.Int);
        pArray[0].Value = ContactID;

        pArray[1] = new SqlParameter("@GrantApplicantID", SqlDbType.Int);
        pArray[1].Value = GrantApplicantID;

        pArray[2] = new SqlParameter("@SystemProviderID", SqlDbType.Int);
        pArray[2].Value = SystemProviderID;

        pArray[3] = new SqlParameter("@BudgetNarrativeID", SqlDbType.Int);
        pArray[3].Value = BudgetNarrativeID;

        pArray[4] = new SqlParameter("@SubContractorName", SqlDbType.VarChar);
        pArray[4].Value = SubContractorName;

        pArray[5] = new SqlParameter("@SubContractorContactName", SqlDbType.Text);
        pArray[5].Value = SubContractorContactName;

        pArray[6] = new SqlParameter("@SubContractorAddress1", SqlDbType.VarChar);
        pArray[6].Value = SubContractorAddress1;

        pArray[7] = new SqlParameter("@SubContractorAddress2", SqlDbType.VarChar);
        pArray[7].Value = SubContractorAddress2;

        pArray[8] = new SqlParameter("@SubContractorCity", SqlDbType.VarChar);
        pArray[8].Value = SubContractorCity;

        pArray[9] = new SqlParameter("@SubContractorState", SqlDbType.VarChar);
        pArray[9].Value = SubContractorState;

        pArray[10] = new SqlParameter("@SubContractorZipcode", SqlDbType.VarChar);
        pArray[10].Value = SubContractorZipcode;

        pArray[11] = new SqlParameter("@SubContractorPhone", SqlDbType.VarChar);
        pArray[11].Value = SubContractorPhone;

        pArray[12] = new SqlParameter("@SubContractorFax", SqlDbType.VarChar);
        pArray[12].Value = SubContractorFax;

        pArray[13] = new SqlParameter("@SubContractorEmail", SqlDbType.VarChar);
        pArray[13].Value = SubContractorEmail;

        pArray[14] = new SqlParameter("@IsFiscalContact", SqlDbType.Int);
        pArray[14].Value = IsFiscalContact;

        pArray[15] = new SqlParameter("@RETURNVALUE", System.Data.SqlDbType.Int);
        pArray[15].Direction = System.Data.ParameterDirection.ReturnValue;

        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspSaveCPPISubcontractorContactData", pArray);

        return Int32.Parse(pArray[15].Value.ToString());
    ...
    public DataSet GetCPPISubContractorsInfo(int GrantApplicantID, int isLeadAgency)
    {
        SqlParameter[] pArray = new SqlParameter[2];
        pArray[0] = new SqlParameter("@GrantApplicantID", SqlDbType.Int);
        pArray[0].Value = GrantApplicantID;
        ...
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetCPPISubContractorsInfo", pArray);
    ...
    public int RegisterNewAgency(string agencyName, string agencyAddress, string agencyCity,
                                 ...
                                 string agencyEmail, string username, string password, string programType, string programName,
                                 int fiscalYear, int fundCode)
    {
        SqlParameter[] pArray = new SqlParameter[15];
        ...
        {
            pArray[11] = new SqlParameter("@ProgramTypeId", SqlDbType.Int);
            pArray[11].Value = programType;
        }

        if (!string.IsNullOrEmpty(programName))
        {
            pArray[12] = new SqlParameter("@UPKProgramName", SqlDbType.VarChar, 300);
            pArray[12].Value = programName;
        }

        pArray[13] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[13].Direction = ParameterDirection.InputOutput;
        pArray[13].Value = -1;

        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspRegisterNewAgency", pArray);

        return Convert.ToInt32(pArray[13].Value.ToString());
    }
    ...
    public float UpdateUPKEligAmountNew(int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[3];
        ...
        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspUpdateUPKEligibilityAmountNew", pArray);

        return (string.IsNullOrEmpty(pArray[1].Value.ToString()) ? 0f : Single.Parse(pArray[1].Value.ToString()));
    }

    public float UpdateUPKClassroomAmountNew(int classroomId, int systemProviderId, int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[4];
        ...
        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspUpdateUPKClassroomAmountNew", pArray);
    ...
    public int DeleteUpkProgramNew(int providerId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        pArray[0] = new SqlParameter("@ProviderId", SqlDbType.Int);
        pArray[0].Value = providerId;
        ...
        return Convert.ToInt32(SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspDeleteUpkProgramNew", pArray));
    }

    public SortedList<string, string> GetUPKProgramSurveyData(int SystemProviderId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        ...
        DataSet ds = SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetUPKProgramSurveyData", pArray);
    ...
    public int SaveUPKProgramSurveyData(int SystemProviderId, string QuestionId, string QuestionAns, int GrantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[4];
        ...
        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspSaveUPKProgramSurveyData", pArray);

        return Int32.Parse(pArray[0].Value.ToString());
    }

    public int SaveUPKClassroomSurveyData(int ClassroomId, int SystemProviderId, string QuestionId, string QuestionAns, int GrantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[5];
        ...
        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspSaveUPKClassroomSurveyData", pArray);

        return Int32.Parse(pArray[0].Value.ToString());
    }

    public int GetUPKClassroomNewId()
    {
        SqlParameter[] pArray = new SqlParameter[1];
        ...
        SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspGetUPKSurveyClassroomNewId", pArray);

        return Int32.Parse(pArray[0].Value.ToString());
    }

    public DataSet GetUPKSurveyClassroomEducators(int classroomId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        ...
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetUPKSurveyClassroomEducators", pArray);
    }

    public void SaveUPKSurveyClassroomEducator(int ClassroomId, string EducatorName, string Position, string EducationLevel, string Salary)
    {
        SqlParameter[] pArray = new SqlParameter[5];
        ...
        pArray[4] = new SqlParameter("@AnnualSalary", SqlDbType.VarChar, 50);
        pArray[4].Value = Salary;

        SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspSaveUPKSurveyClassroomEducator", pArray);
    }

    public void UpdateUPKSurveyClassroomEducator(int EducatorId, string EducatorName, string Position, string EducationLevel, string Salary)
    {
        ...
        SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspUpdateUPKSurveyClassroomEducator", pArray);
    }

    public void DeleteUPKSurveyClassroomEducator(int EducatorId)
    {
        ...
        SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspDeleteUPKSurveyClassroomEducator", pArray);
    }
