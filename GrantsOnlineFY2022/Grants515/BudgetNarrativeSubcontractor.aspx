<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageNEW.master" AutoEventWireup="true"
    CodeFile="BudgetNarrativeSubcontractor.aspx.cs" Inherits="BudgetNarrativeSubcontractor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table id="tblHSBudget" style="width: 100%">
        <tr>
                <td>
                ...
                <table id="tblSuccess" cellpadding="0" cellspacing="0" border="0" class="styleSaved"
                    ...
                    <tr>
                        <td align="center" style="height: 50px; padding-top: 5px">
                            The Subcontractor/Provider Budget has been SAVED successfully.<br />
                            <br />
                            <asp:LinkButton ID="lnkBackToHome" runat="server" Text="Go back to Subcontractor/Provider list" Visible="true"
                                OnClick="btnBackToHome_Click" CausesValidation="false" CssClass="buttonClass2"
                                Width="200px" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="lnkNextPart" runat="server" Text="Go to Budget Summary (Part 6)"
        ...
        <tr>
            <td colspan="7">
                <table id="tblFailed" cellpadding="0" cellspacing="0" border="0" class="styleFailed"
                    ...
                    <tr>
                        <td align="center" style="height: 50px; padding-top: 5px">
                            <span class="styleErrors">The Subcontractor/Provider Budget has been SAVED with the following error(s).<br />
        ...
        <tr>
            <td colspan="7">
                <table id="tblWarnings" cellpadding="0" cellspacing="0" border="0" class="styleWarning"
                    ...
                    <tr>
                        <td align="center" style="height: 50px; padding-top: 5px">
                            <span class="styleErrors">The Subcontractor/Provider Budget has been SAVED with the following warning(s).<br />
        ...
        <tr>
            <td colspan="7">
                <table cellpadding="0" cellspacing="0" class="style41" style="width: 100%;border:1px solid #999999;background-color:#efefef">
                    <tr id="trProviderDDL" runat="server">
                        <td style="width: 240px">
                            <b>Name of Subcontractor/Provider<span style="color: Red">*</span>:</b>
                        </td>
                        <td valign="middle">
                            <asp:DropdownList ID="ddlSubcontractorName" runat="server" Width="400px" MaxLength="100" style="margin-top:5px;margin-bottom:5px"
                                AutoPostBack="true" onselectedindexchanged="ddlSubcontractorName_SelectedIndexChanged">
                                <asp:ListItem Value="0" Text="----------------------------------------------------------------------------------------------"></asp:ListItem>
                            </asp:DropdownList><br />
                            <asp:CustomValidator
                                ID="CustomValidator01" runat="server" ControlToValidate="ddlSubcontractorName" ErrorMessage="Please select one of the subcontractor/Provider names."
                                Display="Dynamic" SetFocusOnError="true"
                                onservervalidate="CustomValidator01_ServerValidate" >
                            </asp:CustomValidator> 
                        </td>
                    </tr>
                    <%--<tr id="trProviderName" runat="server" visible="false" enabled="false">
                        <td style="width: 240px">
                            <b>Name of Subcontractor/Provider<span style="color: Red">*</span>:</b>
                        </td>
                        <td valign="middle">
                            <asp:TextBox ID="txtSubcontractorName" runat="server" Width="400px" MaxLength="100" style="margin-top:5px;margin-bottom:5px" Visible="false" Enabled="false"></asp:TextBox><br />                           
                        </td>
                    </tr>--%>
                    <tr>
                        <td style="width: 240px">
                            <b>Fiscal Contact name<span style="color: Red">*</span>:</b>
                        </td>
                        <td valign="middle">
                            <asp:TextBox ID="txtSubcontractorContact" runat="server" Width="400px" MaxLength="100" style="margin-top:5px;margin-bottom:5px"></asp:TextBox><br />
                            <asp:RequiredFieldValidator
                                ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtSubcontractorContact" ErrorMessage="Please enter the subcontractor/Provider Fiscal contact name."
                                Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:HiddenField ID="hidContactID" runat="server" Value="<%=ContactID%>" />
                        </td>
                    </tr>
                    <tr>
                        <td class="styleLeftCol"><b>
                            Mailing Address Line 1:<font color="red">*</font></b>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSubcontractorAddress1" runat="server" Text="" Width="300px" MaxLength="200"
                                CssClass="inputBox1"></asp:TextBox><br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSubcontractorAddress1"
                                Display="Dynamic" ErrorMessage="Please enter the subcontractor/Provider mailing address line 1." 
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="styleLeftCol"><b>
                            Mailing Address Line 2:</b>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSubcontractorAddress2" runat="server" Text="" Width="300px" MaxLength="200"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtSubcontractorCity" runat="server" Text="" Width="100px" MaxLength="50" CssClass="inputBox1"></asp:TextBox><br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtSubcontractorCity"
                                Display="Dynamic" ErrorMessage="Please enter the subcontractor/Provider city." 
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator120" 
                                runat="server" ControlToValidate="txtSubcontractorCity" Display="Dynamic" 
                    ...
                    <tr>
                        <td class="styleLeftCol"><b>
                            State:<font color="red">*</font></b>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSubcontractorState" runat="server" Text="" Width="50px" MaxLength="2" CssClass="inputBox1"></asp:TextBox><br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtSubcontractorState"
                                Display="Dynamic" ErrorMessage="Please enter the state." 
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator121" 
                                runat="server" ControlToValidate="txtSubcontractorState" Display="Dynamic" 
                                ErrorMessage="Please enter a valid state for the subcontractor/Provider." 
                                ValidationExpression="^([a-zA-z\s]{2,})$"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="styleLeftCol"><b>
                            Zip Code:<font color="red">*</font></b>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSubcontractorZipcode" runat="server" Text="" Width="100px" MaxLength="10"
                                CssClass="inputBox1"></asp:TextBox><br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtSubcontractorZipcode"
                                Display="Dynamic" ErrorMessage="Please enter the zipcode." 
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator122" 
                                runat="server" ControlToValidate="txtSubcontractorZipcode" Display="Dynamic" 
                                ErrorMessage="Please enter a valid zipcode for the subcontractor/Provider." 
                                ValidationExpression="\d{5}(-\d{4})?"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="styleLeftCol"><b>
                            Phone:<font color="red">*</font></b>
                        </td>
                        <td>
                            <asp:TextBox ID="txtSubcontractorPhone" runat="server" Text="" Width="150px" MaxLength="20" CssClass="inputBox1"></asp:TextBox>&nbsp;(Ex:
                            617-111-2222)
                            <br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtSubcontractorPhone"
                                Display="Dynamic" ErrorMessage="Please enter the phone number." 
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator123" runat="server" ControlToValidate="txtSubcontractorPhone"
                    ...
                    <%--<tr>
                        ...
                        <td valign="middle">
                            <asp:TextBox ID="txtSubcontractorPhone" runat="server" Width="400px" MaxLength="20" style="margin-bottom:5px"></asp:TextBox>&nbsp;(Ex:
                            617-111-2222)<br />
                            <asp:RequiredFieldValidator
                                ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtSubcontractorPhone" ErrorMessage="Please enter the subcontractor/Provider phone."
                                Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator107" runat="server"
                                ControlToValidate="txtSubcontractorPhone" Display="Dynamic" ErrorMessage="Invalid phone number"
                                ValidationExpression="^\D?(\d{3})\D?\D?(\d{3})\D?(\d{4})$((x){0,1}([0-9]){1,5}){0,1}$" 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtSubcontractorFax" runat="server" Text="" Width="150px" MaxLength="20" CssClass="inputBox1"></asp:TextBox><br />
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator124" runat="server"
                                ControlToValidate="txtSubcontractorFax" Display="Dynamic" ErrorMessage="Invalid fax number"
                    ...
                    <tr>
                        ...
                        <td valign="middle">
                            <asp:TextBox ID="txtSubcontractorEmail" runat="server" Width="400px" MaxLength="100" style="margin-bottom:5px"></asp:TextBox><br />
                            <asp:RequiredFieldValidator
                                ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSubcontractorEmail" ErrorMessage="Please enter the subcontractor/Provider email."
                                Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator106" runat="server"
                                ControlToValidate="txtSubcontractorEmail" Display="Dynamic" ErrorMessage="Invalid email"
                                ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" 
                                SetFocusOnError="True">Please enter a valid email address.</asp:RegularExpressionValidator>
                        </td>
                    </tr>                   
                </table>
            </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: 80px">
        <tr>
            <td align="center">
                <asp:LinkButton ID="btnPrintHSBudget" runat="server" Text="Save and Print" OnClick="btnPrintHSSubBudget_Click"
                ...
                <asp:LinkButton ID="btnSaveHome" CssClass="buttonClass" runat="server" Text="Save Subcontractor/Provider Budget"
