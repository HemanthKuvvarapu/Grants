...
public partial class CheckList : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        else
        {
            ...
            btnSelectCommuntiesServedPart2.Visible = false;
        }
        ...
        else
        {
            ...
            btnSelectProjectedDeliverablePart8.Visible = false;
        }
    ...
    private bool isValidBudgetSummary(out int errorCount, out bool isNoRecord)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            if (!GlobalFunc.isValidBudgetUpToEligibilityAmount(Int32.Parse(Single.Parse(ds.Tables[0].Rows[0]["EligibilityAmount"].ToString()).ToString()), ds))
            {
                errorCount++;
            }
