...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <legend><span class="style13">Head Start Site Survey FY <%=AppInfo.FiscalYear%>: Center-Based</span></legend>
<div>
            ...
            <asp:CompareValidator ID="CompareValidator3" runat="server" 
               ...
               <tr>
                <td align="center" class="auto-style2">
                    <asp:Button ID="btnAddNew" runat="server" Text="Add New Center-Based Program" 
