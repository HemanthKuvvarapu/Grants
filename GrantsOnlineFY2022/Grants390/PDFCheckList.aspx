    ...
    <table id="tblCheckList" runat="server" cellpadding="2" cellspacing="2" width="100%"
        ...
        <tr>
            ...
            <td>
                ...
                <span style="color:red">Please Note: The Required Grant Forms must be submitted as hard copies as these do not print as part of the PDF document. <u>Grant applications will be considered incomplete if hard copies are not received</u>.</span>    
            </td>
        </tr>
        <tr>
            <td align="center">
        ...
        <tr>
            ...
            <td style="color: red">We are not requiring that you submit hard copies of the grant application to EEC.  This means that you need to <b><i>submit the online application electronically</i></b> by the grant submission date, including uploading the required grant forms. <b><i>PLEASE DO NOT SEND ANY HARD COPIES OF THE GRANT APPLICATION TO EEC.</i></b>  We will send an approval email to you once we complete the grant review and the follow-up correspondences.  Once you receive that approval email, you will submit the <b><i>final-approved grant application as a PDF hard copy to EEC.</i></b>
