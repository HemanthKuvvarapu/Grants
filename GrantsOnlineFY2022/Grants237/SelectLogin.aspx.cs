...
public partial class SelectLogin : System.Web.UI.Page
{
    ...
    private void loadAgencyInfo()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (AppInfo.FundCode == 237)
            {
                Session["PCHPAgency"] = ds.Tables[0].Rows[0]["IsPCHP"].ToString();

                AppInfo.DisplayPart4a = (ds.Tables[0].Rows[0]["IsPCHP"].ToString() == "1") ? true : false;
            }
        }
    }
    ...
    private void NextPage()
    {
        ...
        {
            if (AppInfo.FundCode == 390 && AppInfo.FiscalYear == 2018)
            {
