...
public class Amendment
{
                                                ...
                                                int isPCHP)
    {
        ...
        pArray[3] = new SqlParameter("@IsPCHP", SqlDbType.Int);
        pArray[3].Value = isPCHP;
    ...
    public DataSet GetPCHPAmendmentInfo(int GrantApplicantID, int version)
    {
    ...
    public DataSet GetAvailPCHPAmendmentList(int GrantApplicantID, int version)
    {
        SqlParameter[] pArray = new SqlParameter[4];
