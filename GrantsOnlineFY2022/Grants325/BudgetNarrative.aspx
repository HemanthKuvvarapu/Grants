...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <table id="tblHSBudget" style="width: 100%; font-family: Arial; font-size: 13px">
                    ...
                    <table id="tblSuccess" cellpadding="0" cellspacing="0" border="0" class="styleSaved"
                        ...
                        <tr>
                            <td align="center" style="height: 50px; padding-top: 5px">
                                ...
                                <asp:LinkButton ID="lnkNextPart" runat="server" Text="Go to Subcontractor"
            ...
            <tr>
                <td class="style41">
                    Indirect Costs<br /><br />Under no circumstances can the use of the indirect cost rate exceed the amount of funds (10% of the total grant) allocated to administrative purposes.
                </td>
