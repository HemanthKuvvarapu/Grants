...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <legend>&nbsp;<span class="style17">Head Start and Early Head Start Site Survey FY <%=AppInfo.FiscalYear%>: Home-Based</span></legend>
    ...
    <tr>
                <td align="center" class="auto-style2">
                    <asp:Button ID="btnAddNew" runat="server" Text="Add Home-Based Program(s)" 
