...
public class GlobalFuncAmendment
{
    ...
    public static bool isValidContractPaidRateAmendment(List<string> errorBoxes, DataRow dr)
    {
        ...
        //if ((!string.IsNullOrEmpty(dr["CSSpeakerRate"].ToString())) && (Single.Parse(dr["CSSpeakerRate"].ToString().Trim()) > 0.00f) && (Int32.Parse(dr["CSSpeakerHrWkDayFlat"].ToString().Trim()) == 0))
    ...
    public static bool isValidProgramAdminCostsAmendment(List<string> errorBoxes, DataSet ds)
    {
        ...
        //Add same fix as in FY2019 Career Pathways 325
        //rate
    ...
    public static bool isValidBudgetAmendmentSummaryEECAdminLimit(DataSet ds, int eligAmount, out float amount, float perc)
    {
        amount = 0.0f;
