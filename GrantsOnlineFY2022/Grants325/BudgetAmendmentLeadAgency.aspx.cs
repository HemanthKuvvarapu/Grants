...
public partial class BudgetAmendmentLeadAgency : System.Web.UI.Page
{
    DAL dal = new DAL();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Master.PartTitle = "Lead Agency Budget Amendment #" + ViewState["AmendmentVersion"].ToString();
    }
    ...
    private bool hasValidationErrors(bool isAfterSaved)
    {
        ...
        {
            lstErrors.Items.Add("please reduce number of staff and FTE.");
            errorCount++;
        }
        if (!GlobalFuncAmendment.isValidTravelAmendment(lstErrorBoxes, ds))
        {
            lstErrors.Items.Add("please reduce Mileage Rate.");
            errorCount++;
        }
        ...
        //if (!GlobalFuncAmendment.isValidBudgetAmendmentUpToEligibilityAmount(lstErrorBoxes, ds))//, ViewState["AmendmentVersion"].ToString()))
        //{
        //    DataRow dr3 = ds.Tables[3].Rows[0];
        //    decimal origAlloc = Convert.ToDecimal(dr3["OriginalBudgetAlloc"].ToString());
        //    decimal amendAlloc = 0;
        //    decimal amendAllocAdd = origAlloc;

        //    switch (ViewState["AmendmentVersion"].ToString() )
        //    {
        //        case "1":
        //            amendAlloc = Convert.ToDecimal(dr3["Amendment1Eligibility"].ToString());
        //            amendAllocAdd = origAlloc + Convert.ToDecimal(dr3["Amendment1Eligibility"].ToString());
        //            break;
        //        case "2":
        //            amendAlloc = Convert.ToDecimal(dr3["Amendment2Eligibility"].ToString());
        //            origAlloc = origAlloc + Convert.ToDecimal(dr3["Amendment1Eligibility"].ToString());
        //            amendAllocAdd = origAlloc + Convert.ToDecimal(dr3["Amendment2Eligibility"].ToString());
        //            break;
        //        case "3":
        //            amendAlloc = Convert.ToDecimal(dr3["Amendment3Eligibility"].ToString());
        //            origAlloc = origAlloc + Convert.ToDecimal(dr3["Amendment1Eligibility"].ToString()) + Convert.ToDecimal(dr3["Amendment2Eligibility"].ToString());
        //            amendAllocAdd = origAlloc + Convert.ToDecimal(dr3["Amendment3Eligibility"].ToString());
        //            break;
        //        case "":
        //            break;
                
        //    }
        //    lstErrors.Items.Add("Budget Amendment Version " + ViewState["AmendmentVersion"].ToString() + " cannot exceed " + amendAlloc.ToString("N2") + " more than the maximum Eligibility $" + origAlloc.ToString("N2") + ", or $" + amendAllocAdd.ToString("N2") + ".");
        //    errorCount++;
        //}
    ...
    protected void btnPrintHSBudget_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Print.aspx?type=LeadAgencyBudgetAmendment");
    }
