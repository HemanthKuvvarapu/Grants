<%@ Page Language="C#" MasterPageFile="~/MasterPageNEW0.master" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Register" Title="Untitled Page" %>

<%@ MasterType VirtualPath="~/MasterPageNEW0.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-family: Arial;
        ...
        <tr>
            <td class="styleInst">
                <b>INSTRUCTIONS: Complete the Lead Agency/School District information below. Note: The fields marked with an <font color="red">*</font> are required.</b>
                <br />Please note: your <b>Vendor Name</b> needs to match your <b>Legal Name</b>. If you have a previous grant with EEC, please make sure your <b>legal name</b> matches the name on your <b>Standard Contract Form</b> with EEC or your <b>W-9 form</b>.
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td colspan="2">
                <table cellpadding="0" cellspacing="0" border="0" class="styleAlt1" style="width: 100%">
                    <tr>
                        <td class="styleLeftCol" style="width: 40%;padding-top:3px" valign="top">
                            Vendor Name (Your Lead Agency/School District Name):<font color="red">*</font>
                        </td>
                        <td style="width: 60%">
                            <asp:TextBox ID="txtAgencyName" runat="server" Text="" Width="300px" MaxLength="200"
                    ...
                    <%--<tr id="trUPKProgramType" runat="server">
                        <td class="styleLeftCol" style="width: 35%">
                            What program type is your program:<font color="red">*</font>
                        </td>
                        <td style="width: 65%">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="cboProgramType"
                                Display="Dynamic" ErrorMessage="Please enter the program type." 
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr id="blkProgramName" runat="server" visible="false">
                        <td class="styleLeftCol" style="width: 35%;padding-top:3px" valign="top">
                            Program Name:<font color="red">*</font>
                        </td>
                        <td style="width: 65%">
                            <asp:TextBox ID="txtProgramName" runat="server" Text="" Width="200px" MaxLength="200"
                                CssClass="inputBox1"></asp:TextBox><br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtProgramName"
                                Display="Dynamic" ErrorMessage="Please enter the program name." 
                                SetFocusOnError="True"></asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td class="styleLeftCol" valign="top" style="padding-top:3px">
                            Lead Agency/School District Legal Address<font color="red">*</font>
                        </td>
                        <td>
