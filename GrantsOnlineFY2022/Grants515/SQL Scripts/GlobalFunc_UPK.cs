...
public class GlobalFunc
{
    ...
    public static bool isValidProjectedDeliverables(List<string> errorBoxes, DataSet ds)
    {
        ...
        if (string.IsNullOrEmpty(dr["Q7h"].ToString()))
            errorBoxes.Add("txt7h");

        if (string.IsNullOrEmpty(dr["Q7i"].ToString()))
            errorBoxes.Add("txt7i");

        if (string.IsNullOrEmpty(dr["Q7j"].ToString()))
            errorBoxes.Add("txt7j");
        ...
        if (string.IsNullOrEmpty(dr["Q8c"].ToString()))
            errorBoxes.Add("txt8c");

        if (string.IsNullOrEmpty(dr["Q8d"].ToString()))
            errorBoxes.Add("txt8d");
        ...
        if (string.IsNullOrEmpty(dr["Q7hdescr"].ToString()))
            errorBoxes.Add("txt7hdescr");

        if (string.IsNullOrEmpty(dr["Q7idescr"].ToString()))
            errorBoxes.Add("txt7idescr");

        if (string.IsNullOrEmpty(dr["Q7jdescr"].ToString()))
            errorBoxes.Add("txt7jdescr");
        ...
        if (string.IsNullOrEmpty(dr["Q8cdescr"].ToString()))
            errorBoxes.Add("txt8cdescr");

        if (string.IsNullOrEmpty(dr["Q8ddescr"].ToString()))
            errorBoxes.Add("txt8ddescr");
