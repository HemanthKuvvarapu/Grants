        ...
        <table id="printSummaryTable" runat="server" cellpadding="0" cellspacing="0" width="100%" style="border: 3px solid #ff0000;">
            <tr>
                <td style="padding: 5px" class="auto-style1">
                    ...
                    <b>Please Note:  The Required Grant Forms will need to be submitted as hard copies and submitted electronically, as these do not print as part of the PDF document. Please download the forms and attach to the hard Copy of the Grant Application.</b>
                </td>
