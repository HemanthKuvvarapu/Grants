...
public partial class BudgetAmendmentSubcontractor : System.Web.UI.Page
{
    DAL dal = new DAL();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                BindData(Int32.Parse(BudgetNarrativeID), false);
            }
        }

        Master.PartTitle = "Subcontractor Budget Amendment #" + ViewState["AmendmentVersion"].ToString();
    }
    ...
    protected void btnPrintHSSubBudget_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Print.aspx?type=SubcontractorBudgetAmendment");
    }


    private void NextPage(string action)
    {
        Response.Redirect("BudgetNarrativeSubcontractorAmendmentHome.aspx");
    }

    private void BindData(int BudgetNarrativeID, bool isAfterSaved)
    {
        ds = amend.GetBudgetNarrativeDataAmendment(BudgetNarrativeID, Int32.Parse(ViewState["AmendmentVersion"].ToString()));
