<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageNEW.master" AutoEventWireup="true" CodeFile="BudgetNarrativeSummaryProjected2Year.aspx.cs" Inherits="BudgetNarrativeSummaryProjected2Year" %>
            ...
            <tr>
                <td>
                    <table id="tblErrorMessage" cellpadding="0" cellspacing="0" border="0" runat="server" style="background-color:Yellow;height:40px;width:100%;border:solid 1px #ff0000;font-family:Arial">
                        <tr>
                            <td style="color:Red;font-weight:bold;padding:5px">Please complete the FY <%=AppInfo.FiscalYear%>&nbsp;<%=AppInfo.GrantName%>&nbsp;Grant Budget before generating the FY&nbsp;<%=AppInfo.FiscalYear+2%>&nbsp;<%=AppInfo.GrantName%>&nbsp;Grant Budget.</td>
                        </tr>
                    </table>
                </td>
            </tr>
