...
public partial class PDFCheckList : System.Web.UI.Page
{
    ...
    private void BindData(bool isAfterSaved)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (chkA2.Checked && chkA3.Checked && chkA4.Checked && chkA5.Checked && chkA6.Checked && chkA7.Checked && chkA8.Checked && chkA13.Checked && chkA14.Checked && chkA15.Checked && chkA16.Checked && chkA18.Checked && chkA23.Checked && chkA24.Checked  && chkA103.Checked && chkA104.Checked)
            {
                isAllChecked = true;
                dal.UpdatePDFChecklistErrorCount(Int32.Parse(Session["GrantApplicantId"].ToString()), "10", 0);
            }
            else
            {
                //lblErrors.Text = "Please complete and check all boxes.";
                dal.UpdatePDFChecklistErrorCount(Int32.Parse(Session["GrantApplicantId"].ToString()), "10", 1);
            }
        ...
        else
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                CheckBox chkBox = (CheckBox)((WebControl)ContentPlaceHolder.FindControl("chkA10" + row["FileNum"].ToString()));
        ...
        {
            tblSuccess.Visible = true;
            //    tblFailed.Visible = isAfterSaved ? true : false;
        }
    }
