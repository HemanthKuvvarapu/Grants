...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-family: Arial;
        ...
        <tr>
            <td class="styleInst">
                <b>INSTRUCTIONS: Complete the Lead Agency information below. Note: The fields marked with an <font color="red">*</font> are required.</b>
                <br />Please note: your <b>Vendor Name</b> needs to match your <b>Legal Name</b>. If you have a previous grant with EEC, please make sure your <b>legal name</b> matches the name on your <b>Standard Contract Form</b> with EEC or your <b>W-9 form</b>.</td>
        </tr>
    </table>
            ...
            <td colspan="2">
                <table cellpadding="0" cellspacing="0" border="0" class="styleAlt1" style="width: 100%">
                    <tr>
                        ...
                        <td style="width: 65%">
                            <asp:TextBox ID="txtAgencyName" runat="server" Text="" Width="200px" MaxLength="50"
                                CssClass="inputBox1"></asp:TextBox><br /><b>Your <span style="color:red">VENDOR NAME</span> needs to match the <span style="color:red">LEGAL NAME</span> that appears on your <span style="color:red">STANDARD CONTRACT FORM</span></b><br />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtAgencyAddress" runat="server" Text="" Width="300px" MaxLength="200"
                                CssClass="inputBox1"></asp:TextBox><br /><b>Your <span style="color:red">LEGAL ADDRESS</span> needs to match the <span style="color:red">LEGAL ADDRESS</span> that appears on your <span style="color:red">STANDARD CONTRACT FORM</span></b><br />
