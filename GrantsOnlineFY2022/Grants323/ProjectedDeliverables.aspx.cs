...
public partial class ProjectedDeliverables : System.Web.UI.Page
{
    ...
    private void BindData(bool isAfterSaved)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            //txt6k.Text = dr["Q6k"].ToString();
            //txt6l.Text = dr["Q6l"].ToString();
            //txt6m.Text = dr["Q6m"].ToString();
            ...
            //txt6kdescr.Text = dr["Q6kdescr"].ToString();
            //txt6ldescr.Text = dr["Q6ldescr"].ToString();
            //txt6mdescr.Text = dr["Q6mdescr"].ToString();
    ...
    private void setDefaultStyle()
    {
        ...
        //txt6k.CssClass = "styleUnHighlight";
        //txt6l.CssClass = "styleUnHighlight";
        //txt6m.CssClass = "styleUnHighlight";
        ...
        //txt5hdescr.CssClass = "styleUnHighlight";
        //txt5idescr.CssClass = "styleUnHighlight";
        //txt5jdescr.CssClass = "styleUnHighlight";
        ...
        //txt6kdescr.CssClass = "styleUnHighlight";
        //txt6ldescr.CssClass = "styleUnHighlight";
        //txt6mdescr.CssClass = "styleUnHighlight";
    ...
    private int SaveProjectedDeliverablesData()
    {
        ...
        if (Page.IsValid)
        {
            ...
            txtList.Add("Q1i", txt1i.Text);
            txtList.Add("Q1j", txt1j.Text);
            ...
            //txtList.Add("Q6k", txt6k.Text);
            //txtList.Add("Q6l", txt6l.Text);
            //txtList.Add("Q6m", txt6m.Text);
            ...
            descrList.Add("Q1idescr", txt1idescr.Text);
            descrList.Add("Q1jdescr", txt1jdescr.Text);
            ...
            descrList.Add("Q2idescr", txt2idescr.Text);
            ...
            //descrList.Add("Q6kdescr", txt6kdescr.Text);
            //descrList.Add("Q6ldescr", txt6ldescr.Text);
            //descrList.Add("Q6mdescr", txt6mdescr.Text);
