...
public partial class PDFCheckList : System.Web.UI.Page
{
    ...
    private void BindData(bool isAfterSaved)
    {
        ...
        if (AppInfo.DisplayPart4a)
        {
            blkPCHPBudget.Visible = true;
        }
        else
        {
            blkPCHPBudget.Visible = false;
        }
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
           ...
           // chkA12.Checked = (dr["A12"].ToString() == "X");
            ...
            chkA27.Checked = (dr["A27"].ToString() == "X");
            ...
            chkE27.Checked = (dr["E27"].ToString() == "X");
            ...
            chkA106.Checked = (dr["A106"].ToString() == "X");
            chkA107.Checked = (dr["A107"].ToString() == "X");
            chkA108.Checked = (dr["A108"].ToString() == "X");
            chkA109.Checked = (dr["A109"].ToString() == "X");
            chkA110.Checked = (dr["A110"].ToString() == "X");
            chkA111.Checked = (dr["A111"].ToString() == "X");
            chkA112.Checked = (dr["A112"].ToString() == "X");
        }
        else
        {
    ...
    protected void btnSavePrint_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("Print.aspx?type=pdfchecklistPCHP");
        }
        else
        {
