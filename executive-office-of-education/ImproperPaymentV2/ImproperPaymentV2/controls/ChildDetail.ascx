...
<table id="childInfo2" class="formtext" cellpadding="0" cellspacing="0" border="0"
    ...
    <tr>
        <td>
            ...
            <asp:HiddenField ID="txtProgramTypeField" runat="server" />
            <asp:HiddenField ID="txtEmploymentTypeField" runat="server" />
            <asp:HiddenField ID="txtPartTimeHoursField" runat="server" />
            <asp:HiddenField ID="txtFullTimeHoursField" runat="server" />
            <asp:HiddenField ID="txtTravelTimeField" runat="server" />
            ...
            <asp:HiddenField ID="txtReviewerProgramTypeField" runat="server" />
            <asp:HiddenField ID="txtReviewerEmploymentTypeField" runat="server" />
            <asp:HiddenField ID="txtReviewerPartTimeHoursField" runat="server" />
            <asp:HiddenField ID="txtReviewerFullTimeHoursField" runat="server" />
            <asp:HiddenField ID="txtReviewerTravelTimeField" runat="server" />
            ...
            <script language="javascript" type="text/javascript">
                var authoInfo = new Array(new Array('FeeLevel','<%=txtFeeLevelField.ClientID%>'),
                                          ...
                                          new Array('ProgramType', '<%=txtProgramTypeField.ClientID%>'),
                                          new Array('EmploymentType', '<%=txtEmploymentTypeField.ClientID%>'),
                                          new Array('PartTimeHours', '<%=txtPartTimeHoursField.ClientID%>'),
                                          new Array('FullTimeHours', '<%=txtFullTimeHoursField.ClientID%>'),
                                          new Array('TravelTime', '<%=txtTravelTimeField.ClientID%>'));
                ...
                var reviewerEntryInfo = new Array(new Array('FeeLevel', '<%=txtReviewerFeeLevelField.ClientID%>'),
                                          ...
                                          new Array('ProgramType', '<%=txtReviewerProgramTypeField.ClientID%>'),
                                          new Array('EmploymentType', '<%=txtReviewerEmploymentTypeField.ClientID%>'),
                                          new Array('PartTimeHours', '<%=txtReviewerPartTimeHoursField.ClientID%>'),
                                          new Array('FullTimeHours', '<%=txtReviewerFullTimeHoursField.ClientID%>'),
                                          new Array('TravelTime', '<%=txtReviewerTravelTimeField.ClientID%>'));
                ...
                function setReviewerAuthoInfo(type, source)
                {
                    for (var i=0; i<reviewerEntryInfo.length; i++)
                    {
                        if (type == reviewerEntryInfo[i][0])
                        {
                            if (type == "VarianceAmount") { // calculate the Variance (subtract Reviewer amount from Autho amount)
                                ...
                                else {  // if no reviewer value then set variance to 0
                                    document.getElementById(reviewerEntryInfo[i][1]).value = "0.00";
                                }   
                            }
                            //GET Responsible AND SMI!!!
                            else {
...
<table id="childInfo3" runat="server" class="formtext" cellpadding="0" cellspacing="0" border="0"
    ...
    <tr>
        ...
        <asp:GridView ID="grdChildList" runat="server" AllowSorting="False" AutoGenerateColumns="False" border="1" CellPadding="1" CellSpacing="1" > 
                ...
                <asp:BoundField DataField="ProgDesc" HeaderText= "Program Description" />
                <asp:BoundField DataField="Rate" HeaderText= "Line Item Rate" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Right" />
                ...
                <asp:BoundField DataField="Units" HeaderText= "Billable Units" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Right" />
                <asp:BoundField DataField="Total" HeaderText="Total Amount" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Right" />
