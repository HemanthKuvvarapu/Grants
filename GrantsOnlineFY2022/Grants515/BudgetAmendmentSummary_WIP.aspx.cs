...
public partial class BudgetAmendmentSummary : System.Web.UI.Page
{
    ...
    private bool hasValidationErrors()
    {
        ...
        if (!GlobalFuncAmendment.isValidBudgetUpToAmendmentSummaryEligibilityAmount(Int32.Parse(Single.Parse(Session["Eligibility Amount"].ToString()).ToString()), ds))
        {
            lstErrors.Items.Add("The requested amount is over the total eligibility amount. Please revise your budget accordingly.");
            errorCount++;
        }
