...
<table id="tblSCs" runat="server" border="0" cellpadding="0" cellspacing="0" style="background-color:#cccccc;border:solid 1px #333333" width="100%">
        ...
        <br /><br />
        <table id="tblPCHP" runat="server" border="0" cellpadding="0" cellspacing="0" style="background-color:#cccccc;border:solid 1px #333333" width="100%">
            <tr>
                <td align="center"><b>ParentChild+ Amendment List</b></td>
            </tr>
            <tr>
                <td>
                    <table id="tblPCHPList" runat="server" border="0" cellpadding="0" cellspacing="0" width="100%">   
                        <tr>
                            <td style="height:50px"><b>&nbsp;PC+:&nbsp;</b>
                                <asp:DropDownList ID="lstPCHP" runat="server"></asp:DropDownList>
                                <asp:Button ID="btnAddNewPCHP" runat="server" Text="Add New PC+ Amendment" onclick="btnAddNewPCHP_Click" /><br />
                                <b>Please click on box that says "Add New PC+ Amendment."</b>
                            </td>
                        </tr>
                    </table>             
                    <asp:GridView ID="grdPCHP" runat="server" AutoGenerateColumns="False" DataKeyNames="BudgetNarrativeID"
                        AlternatingRowStyle-CssClass="AlternateColor2"
                        Width="100%" Height="42px" BackColor="White" BorderColor="#DEDFDE" 
                        BorderStyle="Solid" BorderWidth="1px" CellPadding="4" ForeColor="Black" 
                        GridLines="Vertical" onrowdatabound="grdPCHP_RowDataBound" 
                        onrowdeleting="grdPCHP_RowDeleting" onrowcommand="grdPCHP_RowCommand" 
                        EnableModelValidation="True" >
                        <RowStyle BackColor="#F7F7DE" />
                        <Columns>
                            <asp:HyperLinkField Text="View/Edit">
                            ...
                            <asp:BoundField DataField="AgencyName" HeaderText="ParentChild+ Name">
                                <HeaderStyle HorizontalAlign="Left" Width="300px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="GrantTotal" DataFormatString="{0:c}" 
                                HeaderText="Total Costs" HtmlEncode="true">
                        ...
                        <EmptyDataTemplate>
                            <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                                <tr>
                                    <td align="center"><b>No PCHP Amendment Found</b></td>
                                </tr>
                            </table>
                        </EmptyDataTemplate>
                        <SelectedRowStyle BackColor="#CE5D5A" Font-Bold="True" ForeColor="White" />
