<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="BudgetPCHPNarrative.aspx.cs" Inherits="BudgetPCHPNarrative" %>
                    ...
                    <tr>
                        <td align="center" style="height: 50px; padding-top: 5px">
                            ...
                            <asp:LinkButton ID="lnkBackToHome" runat="server" Text="Go back to Home" Visible="true"
                                ...
                                Width="200px" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="lnkNextPart" runat="server" Text="Go to Subcontractor/Provider Budget (Part 5)"
        ...
        <tr>
            <td colspan="7">
                <table id="tblFailed" cellpadding="0" cellspacing="0" border="0" class="styleFailed"
                    ...
                    <tr>
                        <td align="center" style="height: 50px; padding-top: 5px">
                            <span class="styleErrors">The ParentChild+ Budget has been SAVED with the following error(s).<br />
        ...
        <tr>
            <td colspan="7">
                <table id="tblWarnings" cellpadding="0" cellspacing="0" border="0" class="styleWarning"
                    ...
                    <tr>
                        <td align="center" style="height: 50px; padding-top: 5px">
                            <span class="styleErrors">The ParentChild+ Budget has been SAVED with the following warning(s).<br />
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: 80px">
        <tr>
            <td align="center">
                ...
                <asp:LinkButton ID="btnSaveHome" CssClass="buttonClass" runat="server" Text="Save ParentChild+ Budget"
