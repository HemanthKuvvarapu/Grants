...
public partial class CheckList : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        if (enableSubmit)
        {
            dal.SaveCPPIPartStatus(Convert.ToInt32(Session["GrantApplicantId"].ToString()), "3", 1);
        }
    ...
    {
        string ErrMsg = dal.CheckCPPIFinalSubmit(Convert.ToInt32(Session["GrantApplicantId"]));

        if (ErrMsg != "")
        {
            lblErrMessage.Text = "<ul>" + ErrMsg + "</ul";
