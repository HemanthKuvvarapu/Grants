...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table id="tblCheckList" runat="server" cellpadding="2" cellspacing="2" width="100%"
        ...
        <tr id="blkPCHPBudget" runat="server" visible="false">
            <td align="center">
                <asp:CheckBox ID="chkA27" runat="server" />
            </td>
            <td align="center">
                <asp:CheckBox ID="chkE27" runat="server" />
            </td>
            <td>
                <%=AppInfo.DisplayPart4aTitle%>
            </td>
        </tr>
       ...
       <tr id="BudgetSummary1Year" runat="server" visible="false">
        ...
        <tr>
            <td align="center" valign="top" style="padding-top:10px">
                ...
                <asp:CheckBox ID="chkA109" runat="server" Enabled="false"/><br />
                <asp:CheckBox ID="chkA110" runat="server" Enabled="false"/><br />
                <asp:CheckBox ID="chkA111" runat="server" Enabled="false"/><br />
                <asp:CheckBox ID="chkA112" runat="server" Enabled="false"/><br />
                <br />
            </td>
            <td align="center" valign="top" style="padding-top:10px">
                ...
                <asp:CheckBox ID="chkE109" runat="server" Enabled="false"/><br />
                <asp:CheckBox ID="chkE110" runat="server" Enabled="false"/><br />
                <asp:CheckBox ID="chkE111" runat="server" Enabled="false"/><br />
                <asp:CheckBox ID="chkE112" runat="server" Enabled="false"/><br />
                <br />
            </td>
            <td>
                ...
                <ul type="circle">
                    ...
                    <li>Advisory Council Bylaws (if changing)</li>
                    <li>Lead Agency Organization Chart (if changing)</li>
                    <li>CFCE Program Organization Chart (if changing)</li>
                    <li>Resume of CFCE Coordinator (if changing)</li>
                    <li>Literacy Program Evaluation Form (if changing)</li>
                    <li>Parent Satisfaction Survey (if changing)</li>
                    <li>Lead Agency Indirect Cost Rate Letter (if applicable)</li>
                    <li>Subcontractor/Provider Indirect Cost Rate Letter (if applicable)</li>
                    <li>Local Advisory Council List</li>
                </ul>
