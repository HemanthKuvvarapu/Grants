...
public partial class Register : System.Web.UI.Page
{
    ...
    */
    ...
    protected void CustomValidator1_ServerValidate(object source, ServerValidateEventArgs args)
    {
        ...
        {
            args.IsValid = false;
            CustomValidator1.ErrorMessage = "The agency '" + txtAgencyName.Text + "' had been registered with another user.<br/>If you need password or technical assistance, please contact <a href=\"mailto:EECSubmission@massmail.state.ma.us\">EECSubmission@massmail.state.ma.us</a>.";
        }
    }
}