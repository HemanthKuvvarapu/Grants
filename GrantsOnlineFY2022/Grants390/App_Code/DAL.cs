...
WHERE GrantApplicantId = " + grantApplicantId.ToString() + " ORDER BY p.RegionId";
    ...
    public int SavePDFCheckList(int GrantApplicantId,
           ...
           //int E12, 
           int E13, int E14, int E15, int E16, int E17,
    ...
    public DataSet GetUpkClassrooms(int grantApplicantId)
    {
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.Text, @"SELECT c.UpkClassroomId, c.ClassroomName, c.TotalChildren, c.HighNeedsChildren
                                            FROM dbo.UpkClassroom c WHERE c.GrantApplicantId = " + grantApplicantId.ToString());
    }
    ...
    {
        SqlParameter[] pArray = new SqlParameter[17];
        pArray[0] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[0].Value = GrantApplicantId;
        ...
        pArray[16] = new SqlParameter("@UpkChildrenTableType", SqlDbType.Structured);
        pArray[16].Value = dtChildren;
        pArray[16].TypeName = "dbo.UpkChildrenTableType";
    ...
    public DataSet GetUpkProgramInformation(int grantApplicantId)
    {
        SqlParameter[] pArray = new SqlParameter[1];
        pArray[0] = new SqlParameter("@GrantApplicantId", SqlDbType.Int);
        pArray[0].Value = grantApplicantId;
...
WHERE g.GrantApplicantId = " + grantApplicantId.ToString()));
    ...
    public DataSet GetUpkSystemProviders(int grantApplicantId)
    {
        ...
        return SqlHelper.ExecuteDataset(GetConnectionString(), CommandType.StoredProcedure, "uspGetUpkSystemProviders", pArray);
    }

    public int UpdatePDFChecklistErrorCount(int grantApplicantId, string partNum, int errorCount)
    {
        SqlParameter[] pArray = new SqlParameter[3];
        ...
        return SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspUpdatePDFCheckListErrorCount", pArray);
    }
