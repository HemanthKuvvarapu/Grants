...
WHERE GrantApplicantId = " + grantApplicantId.ToString() + " ORDER BY p.RegionId";
    ...
    public void UpdateEligibilityAmount(int grantApplicantId, int fiscalYear, int fundcode)
    {
        ...
        UpdateEligibilityAmount(grantApplicantId, 0, fiscalYear, fundcode, 1);
    }

    public void UpdateEligibilityAmount(int grantApplicantId, float eligAmount, int fiscalYear, int fundcode)
    {
        //SqlParameter[] pArray = new SqlParameter[4];
        ...
        //SqlHelper.ExecuteNonQuery(GetConnectionString(), CommandType.StoredProcedure, "uspUpdateEligibilityAmount", pArray);
        UpdateEligibilityAmount(grantApplicantId, eligAmount, fiscalYear, fundcode, 0);
    }

    public void UpdateEligibilityAmount(int grantApplicantId, float eligAmount, int fiscalYear, int fundcode, int useTowns)
    {
        SqlParameter[] pArray = new SqlParameter[5];
        ...
        pArray[4] = new SqlParameter("@UseTowns", SqlDbType.Int);
        pArray[4].Value = useTowns;
