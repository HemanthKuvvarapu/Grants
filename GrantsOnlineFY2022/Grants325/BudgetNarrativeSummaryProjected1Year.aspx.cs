...
public partial class BudgetNarrativeSummaryProjected1Year : System.Web.UI.Page
{
    DAL dal = new DAL();
    DataSet ds;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Master.PartTitle = AppInfo.DisplayPart6bTitle;

        lblInstruction.Text = dal.GetPartInstruction(AppInfo.FundCode, AppInfo.FiscalYear, "6b");
    ...
    {
        Response.Redirect("Print.aspx?type=budgetSummaryProjected1Year");
    }
