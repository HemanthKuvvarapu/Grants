...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <tr>
            <td>
                <table id="tblCheckList" runat="server" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr id="blkPCHP1" runat="server">
                        <td class="styleLeftCol">
                            <asp:Button ID="btnSelectLeadAgencyBudgetPart4a" runat="server" CausesValidation="false"
                                Text="View/Edit" Enabled="true" Width="120px" OnClick="btnSelectLeadAgencyBudgetPart4a_Click" />
                        </td>
                        <td class="styleLeftCol">
                            ParentChild+ Budget (Part 4a)
                        </td>
                        <td>
                            <asp:Image ID="imgPart4a" runat="server" ImageUrl="~/Images/InComplete.jpg" />
                        </td>
                        <td>
                            <asp:Label ID="lblErrorPart4a" runat="server" CssClass="styleError"></asp:Label><br />
                            <asp:Label ID="lblWarningPart4a" runat="server" CssClass="styleWarning"></asp:Label>
                        </td>
                    </tr>
                    <tr id="blkPCHP2" runat="server">
                        <td colspan="4">
                            &nbsp;
                        </td>
                    </tr>
    ...
    <table style="border: 1px solid #cccccc; background-color: #cccccc">
        <tr>
            <td style="padding: 5px; " class="auto-style1">
                SUBMIT ONLINE: Once your Online Application is complete, click <i><b>Submit</b></i> at the bottom of the home page to send your Online Application to EEC. 
                </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; font-family: Arial;
        ...
        <tr>
            <td>
                Applicants who have previous contract(s) with the Commonwealth and have up-to-date, ink-signature versions of the W-9 Form, and Authorization for Electronic Funds Transfer on file with the Office of the State Comptroller may submit copies of the signed forms. However, a <b>new Standard Contract Form and Contractor Authorized Signatory Listing</b> with original ink signatures must be submitted for each new contract with the Commonwealth.
                <br /><br />Please note it is the responsibility of the applicant to ensure that EEC has the most current MA Administrative forms. Please submit new forms if there are any changes.<br />
                <ul>
