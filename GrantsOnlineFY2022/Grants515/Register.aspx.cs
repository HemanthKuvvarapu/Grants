...
public partial class Register : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Master.PartTitle = "Register new Lead Agency/School District";
        ...
        if (Page.IsValid)
        {
            try
            {
                int grantApplicantId = dal.RegisterNewAgency(txtAgencyName.Text,
                                                             ...
                                                             txtUsername.Text,
                                                             txtPassword.Text,
                                                             "0",  //cboProgramType.SelectedValue,
                                                             "FCC Provider",  //((!string.IsNullOrEmpty(cboProgramType.SelectedValue) && cboProgramType.SelectedValue != "4") ? txtProgramName.Text : "FCC Provider"),
                                                             AppInfo.FiscalYear,
                                                             AppInfo.FundCode);
