...
public partial class ProjectedDeliverables : System.Web.UI.Page
{
    ...
    private void BindData(bool isAfterSaved)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            //txt9a.Text = dr["Q9a"].ToString();
            //txt9b.Text = dr["Q9b"].ToString();
            //txt9c.Text = dr["Q9c"].ToString();
            //txt9d.Text = dr["Q9d"].ToString();
            //txt9e.Text = dr["Q9e"].ToString();
    ...
    private int SaveProjectedDeliverablesData()
    {
        ...
        if (Page.IsValid)
        {
            ...
            //descrList.Add("Q1fdescr", txt6fdescr.Text);
