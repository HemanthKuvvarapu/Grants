...
public partial class ProjectedDeliverables : System.Web.UI.Page
{
    ...
    private void BindData(bool isAfterSaved)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            //txt3i.Text = string.IsNullOrEmpty(dr["Q3i"].ToString()) ? "" : Decimal.Parse(dr["Q3i"].ToString()).ToString("N2");
            ...
            txt7h.Text = dr["Q7h"].ToString();
            txt7i.Text = dr["Q7i"].ToString();
            txt7j.Text = dr["Q7j"].ToString();

            txt8a.Text = dr["Q8a"].ToString();
            txt8b.Text = dr["Q8b"].ToString();
            txt8c.Text = dr["Q8c"].ToString();
            txt8d.Text = dr["Q8d"].ToString();

            //txt9a.Text = string.IsNullOrEmpty(dr["Q9a"].ToString()) ? "" : Decimal.Parse(dr["Q9a"].ToString()).ToString("N2");
            //txt9b.Text = string.IsNullOrEmpty(dr["Q9b"].ToString()) ? "" : Decimal.Parse(dr["Q9b"].ToString()).ToString("N2");
            //txt9c.Text = string.IsNullOrEmpty(dr["Q9c"].ToString()) ? "" : Decimal.Parse(dr["Q9c"].ToString()).ToString("N2");
            //txt9d.Text = string.IsNullOrEmpty(dr["Q9d"].ToString()) ? "" : Decimal.Parse(dr["Q9d"].ToString()).ToString("N2");
            //txt9e.Text = string.IsNullOrEmpty(dr["Q9e"].ToString()) ? "" : Decimal.Parse(dr["Q9e"].ToString()).ToString("N2");
            ...
            txt7hdescr.Text = dr["Q7hdescr"].ToString();
            txt7idescr.Text = dr["Q7idescr"].ToString();
            txt7jdescr.Text = dr["Q7jdescr"].ToString();

            txt8adescr.Text = dr["Q8adescr"].ToString();
            txt8bdescr.Text = dr["Q8bdescr"].ToString();
            txt8cdescr.Text = dr["Q8cdescr"].ToString();
            txt8ddescr.Text = dr["Q8ddescr"].ToString();

            //txt9adescr.Text = dr["Q9adescr"].ToString();
            //txt9bdescr.Text = dr["Q9bdescr"].ToString();
            //txt9cdescr.Text = dr["Q9cdescr"].ToString();
            //txt9ddescr.Text = dr["Q9ddescr"].ToString();
            //txt9edescr.Text = dr["Q9edescr"].ToString();
    ...
    private void setDefaultStyle()
    {
        ...
        txt7h.CssClass = "styleUnHighlight";
        txt7i.CssClass = "styleUnHighlight";
        txt7j.CssClass = "styleUnHighlight";

        txt8a.CssClass = "styleUnHighlight";
        txt8b.CssClass = "styleUnHighlight";
        txt8c.CssClass = "styleUnHighlight";
        txt8d.CssClass = "styleUnHighlight";

        //txt9a.CssClass = "styleUnHighlight";
        //txt9b.CssClass = "styleUnHighlight";
        //txt9c.CssClass = "styleUnHighlight";
        //txt9d.CssClass = "styleUnHighlight";
        //txt9e.CssClass = "styleUnHighlight";
        ...
        txt5fdescr.CssClass = "styleUnHighlight";
        txt5gdescr.CssClass = "styleUnHighlight";
        ...
        txt6gdescr.CssClass = "styleUnHighlight";
        txt6hdescr.CssClass = "styleUnHighlight";
        txt6idescr.CssClass = "styleUnHighlight";
        txt6jdescr.CssClass = "styleUnHighlight";
        ...
        txt7hdescr.CssClass = "styleUnHighlight";
        txt7idescr.CssClass = "styleUnHighlight";
        txt7jdescr.CssClass = "styleUnHighlight";

        txt8adescr.CssClass = "styleUnHighlight";
        txt8bdescr.CssClass = "styleUnHighlight";
        txt8cdescr.CssClass = "styleUnHighlight";
        txt8ddescr.CssClass = "styleUnHighlight";

        //txt9adescr.CssClass = "styleUnHighlight";
        //txt9bdescr.CssClass = "styleUnHighlight";
        //txt9cdescr.CssClass = "styleUnHighlight";
        //txt9ddescr.CssClass = "styleUnHighlight";
        //txt9edescr.CssClass = "styleUnHighlight";
    }
    ...
    private int SaveProjectedDeliverablesData()
    {
        ...
        if (Page.IsValid)
        {
            ...
            txtList.Add("Q1g", txt1g.Text);
            txtList.Add("Q1h", txt1h.Text);
            ...
            txtList.Add("Q7h", txt7h.Text);
            txtList.Add("Q7i", txt7i.Text);
            txtList.Add("Q7j", txt7j.Text);

            txtList.Add("Q8a", txt8a.Text);
            txtList.Add("Q8b", txt8b.Text);
            txtList.Add("Q8c", txt8c.Text);
            txtList.Add("Q8d", txt8d.Text);

            //txtList.Add("Q9a", txt9a.Text);
            //txtList.Add("Q9b", txt9b.Text);
            //txtList.Add("Q9c", txt9c.Text);
            //txtList.Add("Q9d", txt9d.Text);
            //txtList.Add("Q9e", txt9e.Text);
            ...
            descrList.Add("Q1gdescr", txt1gdescr.Text);
            descrList.Add("Q1hdescr", txt1hdescr.Text);
            ...
            descrList.Add("Q7hdescr", txt7hdescr.Text);
            descrList.Add("Q7idescr", txt7idescr.Text);
            descrList.Add("Q7jdescr", txt7jdescr.Text);

            descrList.Add("Q8adescr", txt8adescr.Text);
            descrList.Add("Q8bdescr", txt8bdescr.Text);
            descrList.Add("Q8cdescr", txt8cdescr.Text);
            descrList.Add("Q8ddescr", txt8ddescr.Text);

            //descrList.Add("Q9adescr", txt9adescr.Text);
            //descrList.Add("Q9bdescr", txt9bdescr.Text);
            //descrList.Add("Q9cdescr", txt9cdescr.Text);
            //descrList.Add("Q9ddescr", txt9ddescr.Text);
            //descrList.Add("Q9edescr", txt9edescr.Text);
