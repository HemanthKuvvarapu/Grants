...
public partial class BudgetPCHPNarrative : System.Web.UI.Page
{
    DAL dal = new DAL();
    DataSet ds;
    DataSet ds2;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Master.PartTitle = AppInfo.DisplayPart4aTitle;

        lblInstruction.Text = dal.GetPartInstruction(AppInfo.FundCode, AppInfo.FiscalYear, "4a");
    ...
    protected void btnSaveHome_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            BudgetNarrativeID = SaveBudgetNarrativeSubcontractorData(1);
    ...
    protected void btnPrintHSSubBudget_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Print.aspx?type=BudgetPCHP");
    }
    ...
    {
        ds = dal.GetBudgetPCHPNarrativeDataNew(Int32.Parse(Session["GrantApplicantId"].ToString()));

        if (ds.Tables[0].Rows.Count > 0)
        {
            DataRow dr = ds.Tables[0].Rows[0];

            ViewState["BudgetNarrativeID"] = Int32.Parse(dr["BudgetNarrativeID"].ToString());
