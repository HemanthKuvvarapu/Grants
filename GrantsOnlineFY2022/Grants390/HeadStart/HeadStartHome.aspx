...
<ol type="1" style="font-size:14px">
    <li><asp:HyperLink ID="lnkHeadStartSiteSurvey" Enabled="true" runat="server">FY <%=AppInfo.FiscalYear%> Head Start and Early Head Start Site Survey</asp:HyperLink><br /><br /><br /></li>
