    ...
    <table id="tblData" runat="server" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #FFFFCC">
        ...
        <tr>
            ...
            <%--Add Program question section--%>
                <tr>
                    <td colspan="1" style="background-color:#ffffff"><b>Instructions:</b>&nbsp;For each question, please provide information as of March 1, 2019 and the projected enrollment of June 1, 2019.</td>
                </tr>
                <tr style="background-color: #6699FF; color: #FFFFFF">
                ...
                <tr>
                    <td colspan="2">1. Number of children to be enrolled in this CPPI-funded program by <b>Age</b>:</td>
                </tr>
                <tr>
                    <td colspan="2">
                    <br />
                        <table cellpadding="5" cellspacing="0" border="0" style="border:solid 1px #333333"  rules="all">
                            <tr>
                                <td style="width:40%">&nbsp;</td>
                                <td style="width:20%;text-align:center"><b>PropProposed Target Enrollment
                                    <br />
                                    </b></td>
                            ...
                            <tr>
                                <td style="height:40px">Of the total, number of <b>3 year-olds</b> (defined as those eligible for Kindergarten by 2020).</td>
                                <td style="text-align:center"><asp:TextBox ID="txtQ1_2_1" runat="server" 
                                        Width="50px" MaxLength="5" Text="0" Height="22px"></asp:TextBox>                            
                                <br/>
                                    <%--<asp:CompareValidator 
                                        ID="CompareValidator137" runat="server" Display="Dynamic" ValidationGroup="validation"
                                        ErrorMessage="Please enter a valid number greater than 0." ControlToValidate="txtQ1_2_1" 
                                        Operator="GreaterThanEqual" ValueToCompare="1" Type="Integer"></asp:CompareValidator>
                            ...
                            <tr>
                                <td style="height:40px">Of the total, number of <b>4 year-olds</b> (defined as those eligible for Kindergarten by Sept. 2019)</b>.</td>
                                ...
                                <br/>
                                    <%--<asp:CompareValidator 
                                        ...
                                        ErrorMessage="Please enter a valid number greater than 0." ControlToValidate="txtQ1_3_1" 
                                        Operator="GreaterThanEqual" ValueToCompare="1" Type="Integer"></asp:CompareValidator>
                            ...
                            <tr>
                                ...
                                <br/>
                                    <%--<asp:CompareValidator 
                                        ...
                                        ErrorMessage="Please enter a valid number greater than 0." ControlToValidate="txtQ1_5_1" 
                                        Operator="GreaterThanEqual" ValueToCompare="1" Type="Integer"></asp:CompareValidator>
                ...
                <tr>
                    ...
                    <br />
                        <table cellpadding="5" cellspacing="0" border="0" style="border:solid 1px #333333" rules="all">
                            <tr>
                                <td style="width:40%">&nbsp;</td>
                                <td style="width:20%;text-align:center" colspan="2"><b>PropProposed Target Enrollment
                                    </b></td>
