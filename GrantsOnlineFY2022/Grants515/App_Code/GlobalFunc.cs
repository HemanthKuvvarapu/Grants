...
public class GlobalFunc
{
    ...
    public static bool isValidBudgetUpToEligibilityAmount(int AllocFund, DataSet dsSumm)
    {
        DataRow dr = dsSumm.Tables[0].Rows[0];

        int GrandTotal = Int32.Parse(dr["BudgetAmountTotal"].ToString());
    ...
    public static bool isValidProgramAdminCosts(List<string> errorBoxes, DataSet ds)
    {
        ...
        if ((Int32.Parse(dr["CSAdvisorColD"].ToString()) == 0 && Int32.Parse(dr["CSAdvisorColF"].ToString()) == 0) &&
            ...
            ((Single.Parse(dr["CSAdvisorRate"].ToString().Trim()) > 0.00f)))
        {
        ...
        if ((Int32.Parse(dr["CSOtherColD"].ToString()) == 0 && Int32.Parse(dr["CSOtherColF"].ToString()) == 0) &&
            ...
            (Single.Parse(dr["CSOtherRate"].ToString().Trim()) > 0.00f))
        {
