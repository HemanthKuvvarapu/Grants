<%@ Page Language="C#" MasterPageFile="~/MasterPage4.master" AutoEventWireup="true" CodeFile="PreschoolGrantNotAvailable.aspx.cs" Inherits="Preschool_2017_PreschoolGrantNotAvailable" Title="Untitled Page" %>
            ...
            <tr>
                <td>
                    <table id="tblErrorMessage" cellpadding="0" cellspacing="0" border="0" runat="server" style="background-color:Yellow;height:80px;width:100%;border:solid 1px #ff0000;font-family:Arial">
                        <tr>
                            <td style="color:Red;font-weight:bold;padding:5px" align="center">Please complete the UPK survey before continuing to the Online Application.<br /><br /></td>
                        </tr>
                        <tr>
                            <td align="center">
