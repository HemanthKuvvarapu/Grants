...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <%-- <asp:LinkButton ID="lbtnShowAll" runat="server" 
    ...
    <asp:LinkButton ID="lbtnShowPart4Data" runat="server" 
        ...
        <br />
        <br />
   <asp:LinkButton ID="lbtnShowPart4aData" runat="server" 
            Text="Show PC+ Budget (Part 4a) Data " onclick="lbtnShowPart4aData_Click"></asp:LinkButton>
        <br />
        <br />
    ...
    <asp:LinkButton ID="lbtnShowPart6aData" runat="server" 
     ...
     <% } %>
       ...
       <asp:LinkButton ID="lbtnShowPart10Data" runat="server" 
        ...
        <br /> 
        <br />      
        <asp:LinkButton ID="lbtnShowPCHPFamilyForm" runat="server" 
            Text="PCHP Family Form" onclick="lbtnShowPCHPFamilyFrom_Click" Visible="true"></asp:LinkButton>
        <br /> 
        <br />     
    </p>
