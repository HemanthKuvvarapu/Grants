...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <legend><span class="style13">Head Start and Early Head Start Site Survey FY <%=AppInfo.FiscalYear%>: Family Child Care</span></legend>
<table id=tblHSFCC runat=server width=100% border=0>
    ...
    <tr>
                <td align="center" class="auto-style2">
                    <asp:Button ID="btnAddNew" runat="server" Text="Add Family Child Care Program(s)" 
