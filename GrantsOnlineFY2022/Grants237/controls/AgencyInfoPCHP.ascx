<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AgencyInfoPCHP.ascx.cs" Inherits="controls_AgencyInfoPCHP" %>
...
<table id="tblAgency" cellpadding="0" cellspacing="0" border="0" style="width:100%" runat="server">
    <tr>
        ...
        <td style="width:30%;text-align:right;padding-right:20px;font-family:Arial;font-size:small;visibility:hidden">
