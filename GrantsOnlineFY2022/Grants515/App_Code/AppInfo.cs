...
public class AppInfo
{
    ...
    public static string FundCodeText;
    public static string GrantName;
    public static string GrantAbbrev;
    ...
    public static bool InitialUpdate;
    public static bool MarchUpdate;
    public static bool JuneUpdate;
    ...
    static AppInfo()
    {
        ...
        FundCodeText = System.Configuration.ConfigurationManager.AppSettings.Get("FundCodeText").ToString();
        GrantName = System.Configuration.ConfigurationManager.AppSettings.Get("GrantName").ToString();
        GrantAbbrev = System.Configuration.ConfigurationManager.AppSettings.Get("GrantAbbrev").ToString();
        ...
        InitialUpdate = Boolean.Parse(System.Configuration.ConfigurationManager.AppSettings.Get("InitialUpdate").ToString());
        MarchUpdate = Boolean.Parse(System.Configuration.ConfigurationManager.AppSettings.Get("MarchUpdate").ToString());
        JuneUpdate = Boolean.Parse(System.Configuration.ConfigurationManager.AppSettings.Get("JuneUpdate").ToString());
    }
}
