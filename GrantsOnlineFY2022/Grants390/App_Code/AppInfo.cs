...
public class AppInfo
{
    ...
    public static bool EnableBothAmendmentAndOnline;
    ...
    static AppInfo()
    {
        ...
        EnableBothAmendmentAndOnline = Boolean.Parse(System.Configuration.ConfigurationManager.AppSettings.Get("EnableBothAmendmentAndOnline").ToString());
